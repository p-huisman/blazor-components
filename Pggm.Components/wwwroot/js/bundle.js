...
var Kn = (r, s, e) => s in r ? bi(r, s, {
  ...
  , Ie = (r, s) => {
    for (var e in s || (s = {}))
        Ho.call(s, e) && Kn(r, e, s[e]);
    if (fi)
        for (var e of fi(s))
            Zn.call(s, e) && Kn(r, e, s[e]);
    return r
}
  , A1 = (r, s) => Ha(r, Ya(s));
var Gn = (r, s) => {
    var e = {};
    for (var t in r)
        Ho.call(r, t) && s.indexOf(t) < 0 && (e[t] = r[t]);
    if (r != null && fi)
        for (var t of fi(r))
            s.indexOf(t) < 0 && Zn.call(r, t) && (e[t] = r[t]);
    return e
}
;
var ja = (r, s) => () => (s || r((s = {
...
var Wa = (r, s, e, t) => {
    if (s && typeof s == "object" || typeof s == "function")
        for (let i of Pa(s))
            !Ho.call(r, i) && i !== e && bi(r, i, {
                get: () => s[i],
                enumerable: !(t = Un(s, i)) || t.enumerable
            });
    return r
}
;
var Jn = (r, s, e) => (e = r != null ? Oa(Va(r)) : {},
Wa(s || !r || !r.__esModule ? bi(e, "default", {
    value: r,
    enumerable: !0
}) : e, r));
var m = (r, s, e, t) => {
    for (var i = t > 1 ? void 0 : t ? Un(s, e) : s, a = r.length - 1, c; a >= 0; a--)
        (c = r[a]) && (i = (t ? c(s, e, i) : c(i)) || i);
    return t && i && bi(s, e, i),
    i
}
;
var Yo = (r, s, e) => s.has(r) || Qn("Cannot " + e);
var o = (r, s, e) => (Yo(r, s, "read from private field"),
e ? e.call(r) : s.get(r))
  , g = (r, s, e) => s.has(r) ? Qn("Cannot add the same private member more than once") : s instanceof WeakSet ? s.add(r) : s.set(r, e)
  , $ = (r, s, e, t) => (Yo(r, s, "write to private field"),
t ? t.call(r, e) : s.set(r, e),
e)
  , v = (r, s, e) => (Yo(r, s, "access private method"),
e);
var G = (r, s, e) => new Promise( (t, i) => {
    var a = f => {
        try {
            h(e.next(f))
        } catch (w) {
    ...
    h((e = e.apply(r, s)).next())
}
);
var jo = ja( (Po, Vo) => {
    (function(r, s, e) {
        typeof Po == "object" ? (Vo.exports = e(),
        Vo.exports.default = e()) : typeof define == "function" && define.amd ? define(e) : s[r] = e()
    }
    )("slugify", Po, function() {
        ...
        function e(t, i) {
            ...
            var a = s[i.locale] || {}
              ...
              , h = i.trim === void 0 ? !0 : i.trim
              , f = t.normalize().split("").reduce(function(w, k) {
                var x = a[k];
                return x === void 0 && (x = r[k]),
                x === void 0 && (x = k),
                x === c && (x = " "),
                w + x.replace(i.remove || /[^\w\s$*_+~.()'"!\-:@]+/g, "")
            }, "");
            return i.strict && (f = f.replace(/[^A-Za-z0-9\s]/g, "")),
            h && (f = f.trim()),
            f = f.replace(/\s+/g, c),
            i.lower && (f = f.toLowerCase()),
            f
        }
...
var Lt = (r, s, e=!1) => {
  ...
  , vi = r => {
    ...
    if (!r)
        return null;
    let e = ((i = new URL(window.location.href).hash) == null ? void 0 : i.slice(1)) || "";
    return new URLSearchParams(e).get(r)
}
;
var _n = () => Maquette.h("svg", {
    viewBox: "0 0 32 32"
}, Maquette.h("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
...
var t0 = Jn(jo(), 1);
var nd, $i, d0, yi, rd, gt = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, $i);
        g(this, nd, "collapsible");
        this.disabled = !1;
        this.open = !1;
        this.useHashTag = !1;
        this._setHash = e => {
            e && this.useHashTag && Lt(o(this, nd), e, !0)
        }
        ;
        this._onClick = () => {
            this.disabled || v(this, $i, d0).call(this)
        }
        ;
        g(this, yi, () => {
            this.open = !0
        ...
        this._afterContentCreate = () => {
            ...
            e && e.addEventListener("beforematch", o(this, yi))
        }
        ;
        this._setContentHidden = () => {
            var t;
        ...
        this.handleHashChange = () => {
            let e = vi(o(this, nd));
            !e || this.disabled || !this.useHashTag || this.uniqueId === e && o(this, rd).call(this) !== !1 && (this.open = !0)
        }
        ;
        g(this, rd, () => this.dispatchEvent(new CustomEvent("accordionItemToggle",{
            bubbles: !0,
            composed: !0,
            cancelable: !0
        })))
    ...
    render() {
        ...
        }, this.open ? e0() : _n())), Maquette.h("div", {
            id: "content",
            role: "region",
...
$i = new WeakSet,
d0 = function() {
    o(this, rd).call(this) !== !1 && (this.open = !this.open)
}
,
yi = new WeakMap,
rd = new WeakMap,
...
m([Property({
    ...
    reflect: !0
})], gt.prototype, "useHashTag", 2),
gt = m([CustomElementConfig({
    tagName: "pggm-accordion-item"
})], gt);
var i0 = `:host{display:-webkit-box;display:-ms-flexbox;display:flex;width:100%;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;gap:0;gap:var(--pggm-accordion-row-gap,0)}
`;
var ce, ge, M1, R, o0, n0, Wo, xi, ad, sd, wi, qo, Ko, Uo, me = class extends CustomElementController {
    constructor(e, t) {
        super(e);
        this.options = t;
        g(this, R);
        ...
        g(this, sd, e => {
            ...
            t.includes(e.key)) {
                if (e.preventDefault(),
                e.key === "End")
                    v(this, R, qo).call(this);
                else if (e.key === "Home")
                    v(this, R, wi).call(this);
                else if (e.key === "ArrowLeft" || e.key === "ArrowUp") {
                    let i = 1;
                    e.key === "ArrowUp" && (i = o(this, M1)),
                    v(this, R, Ko).call(this, i)
                } else if (e.key === "ArrowRight" || e.key === "ArrowDown") {
                    let i = 1;
                    e.key === "ArrowDown" && (i = o(this, M1)),
                    v(this, R, Uo).call(this, i)
                }
            }
        }
        );
        this.options.directionLength && $(this, M1, this.options.directionLength)
    }
    pause() {
        v(this, R, xi).call(this, o(this, ge))
    }
    resume() {
        v(this, R, Wo).call(this, o(this, ge))
    }
    focusElement(e, t) {
        if (!e) {
            v(this, R, wi).call(this);
...
o0 = function() {
    ...
    v(this, R, Wo).call(this, e),
    $(this, ce, null),
    $(this, ge, e),
    v(this, R, n0).call(this, e)
}
,
n0 = function(e) {
    if (e.length === 0)
        return;
    e.forEach(i => {
        i.dataset.focusGroup = "true",
        this.options.disableTabIndexManagement || (i.tabIndex = -1)
    }
    );
    let t = e.filter(i => this.options.isFocusableElement(i));
    o(this, ce) || $(this, ce, t[0]),
    o(this, ce) && !this.options.disableTabIndexManagement && (o(this, ce).tabIndex = 0)
}
,
Wo = function(e) {
    e.forEach(t => {
        t.addEventListener("focus", o(this, ad)),
        t.addEventListener("keydown", o(this, sd))
    }
    )
}
,
xi = function(e) {
    e.forEach(t => {
        t == null || t.removeEventListener("focus", o(this, ad)),
        t == null || t.removeEventListener("keydown", o(this, sd))
    }
    )
}
,
...
sd = new WeakMap,
wi = function(e) {
    let a = o(this, ge).filter(c => this.options.isFocusableElement(c))[0];
    a && ($(this, ce, a),
    a.focus(e))
}
,
qo = function(e) {
    let i = o(this, ge).filter(c => this.options.isFocusableElement(c))
      , a = i[i.length - 1];
    a && ($(this, ce, a),
    a.focus(e))
}
...
Ko = function(e, t) {
    let i = o(this, ge)
      , a = i.indexOf(o(this, ce))
      , c = i[a - e];
    !this.options.isFocusableElement(c) && this.options.direction === "both" || (c ? ($(this, ce, c),
    this.options.isFocusableElement(c) ? c.focus(t) : this.options.direction !== "both" && v(this, R, Ko).call(this, 1)) : this.options.direction !== "both" && v(this, R, qo).call(this))
}
,
Uo = function(e, t) {
    let i = o(this, ge)
      ...
      , c = i[a + e];
    !this.options.isFocusableElement(c) && this.options.direction === "both" || (c ? ($(this, ce, c),
    this.options.isFocusableElement(c) ? c.focus(t) : this.options.direction !== "both" && v(this, R, Uo).call(this, 1, t)) : this.options.direction !== "both" && v(this, R, wi).call(this, t))
}
;
var ki, r0, Zo, Ei, It = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, ki);
        g(this, Zo, new me(this,{
            direction: "vertical",
    ...
    get items() {
        return [...o(this, ki, r0) || []].filter(e => typeof e.tagName != "undefined")
    }
    render() {
        return Maquette.h("slot", {
            on: {
                accordionItemToggle: o(this, Ei)
            }
        })
    }
}
...
var Ci, Gt, Qo, u0, ld, Ne = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, Gt);
        ...
        this.render = () => Maquette.h("div", {
            ...
            classes: {
                ...
                "notification-has-action": o(this, Gt, Qo)
            }
        ...
        }, p0)) : null, Maquette.h("div", {
            class: "notification-icon",
            "aria-hidden": "true"
        }, this.type === "informative" ? s0 : null, this.type === "error" ? l0 : null, this.type === "success" ? c0 : null, this.type === "warning" ? g0 : null), Maquette.h("div", {
            class: "notification-content"
        }, Maquette.h("slot", null)), o(this, Gt, Qo) ? Maquette.h("div", {
    ...
    updated(e, t, i) {
        e === "open" && i === !0 && requestAnimationFrame( () => this.dispatchEvent(new CustomEvent("openNotification",{
            bubbles: !0,
            composed: !0
        })))
    }
    connectedCallback() {
        this.addEventListener("slotchange", o(this, ld));
        let e = this.querySelector("[slot='header']");
        if (e)
            e.id = "NotificationHeader",
            e.removeAttribute("slot"),
            this.prepend(e);
        else if (o(this, Gt, u0)) {
            let t = this.querySelector("h1,h2,h3,h4,h5");
            t && (t.id = "NotificationHeader")
        }
    }
    disconnectedCallback() {
        this.removeEventListener("slotchange", o(this, ld))
    }
}
;
Ci = new WeakMap,
...
function Ga(r, s) {
    ...
    return s && i.setAttribute("data-name", s),
...
function Ja(r, s) {
    ...
    if (!r.adoptedStyleSheets)
        return !1;
    for (let t of r.adoptedStyleSheets)
        for (let i of t.cssRules) {
            if (i instanceof CSSStyleRule && i.selectorText.indexOf(`[is="${s}"]`) > -1) {
                e = !0;
                break
            }
            if (e)
...
function O(r, s, e) {
    if (!(r instanceof ShadowRoot) && !(r instanceof Document) && (r = r.ownerDocument),
    !Xa(r, e))
        if (m0) {
            let t = new CSSStyleSheet;
            t.replaceSync(`${e}{--_tmp_:1;}${s}`),
            r != null && r.adoptedStyleSheets ? r.adoptedStyleSheets.push(t) : r.adoptedStyleSheets = [t]
        } else {
            let t = Ga(s, e);
            r instanceof Document ? r.head.appendChild(t) : r == null || r.appendChild(t)
        }
}
function Xa(r, s) {
    let e = !1;
    return !(r instanceof ShadowRoot) && !(r instanceof Document) && (r = r.ownerDocument),
    m0 ? e = Ja(r, s) : r.querySelector(`link[data-name="${s}"]`) && (e = !0),
    e
}
var ut = class extends HTMLAnchorElement {
    connectedCallback() {
        O(this.getRootNode(), Ai, ut.TAG_NAME)
    }
}
;
ut.TAG_NAME = "pggm-anchor-button",
ut = m([CustomElementConfig({
    tagName: ut.TAG_NAME,
    options: {
        extends: "a"
    }
})], ut);
var mt = class extends HTMLButtonElement {
    connectedCallback() {
        O(this.getRootNode(), Ai, mt.TAG_NAME)
    }
}
;
mt.TAG_NAME = "pggm-button",
mt = m([CustomElementConfig({
    tagName: mt.TAG_NAME,
    options: {
        extends: "button"
    }
})], mt);
var h0 = `:host{display:inline-block;vertical-align:text-top}.icon__wrapper{display:-webkit-box;display:-ms-flexbox;display:flex}.icon svg{display:block;height:1.5em;height:var(--pggm-icon-functional-size,1.5em);width:1.5em;width:var(--pggm-icon-functional-size,1.5em);stroke:currentColor;stroke:var(--pggm-icon-color,currentColor);fill:currentColor;stroke:none}.icon.icon--s svg{height:1em;height:calc(var(--pggm-icon-functional-size, 1.5em)/1.5);width:1em;width:calc(var(--pggm-icon-functional-size, 1.5em)/1.5)}.icon.icon--l svg{height:2.25em;height:calc(var(--pggm-icon-functional-size, 1.5em)*1.5);width:2.25em;width:calc(var(--pggm-icon-functional-size, 1.5em)*1.5)}.icon.icon--xl svg{height:3em;height:calc(var(--pggm-icon-functional-size, 1.5em)*2);width:3em;width:calc(var(--pggm-icon-functional-size, 1.5em)*2)}.icon.icon--outline svg{fill:none;stroke:currentColor;stroke-width:2;stroke-linecap:round;stroke-linejoin:round}
`;
var f0 = {
    "alert-filled": "\0",
    alert: "\0",
...
var b0 = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0" style="display:none;"><symbol viewBox="0 0 24 24" id="pggm-icons-alert-filled">\r
...
var d2 = ["s", "m", "l", "xl"]
  , p3 = Object.keys(f0)
  , ht = class extends CustomElement {
    constructor() {
        super(...arguments);
        this.size = "m";
        this.render = () => Maquette.h("div", {
...
;
ht.style = h0,
ht.observedAttributes = ["icon", "size", "outline"],
m([Property({
    type: "string",
    attribute: "icon",
    reflect: !0
...
`;
var ft, Jt, Xt, _t, $0, Mi, Di, Si, Go, cd, Be = class extends CustomElement {
    constructor() {
        super();
        g(this, _t);
        g(this, ft);
        ...
        g(this, Mi, e => {
            let t = e.target;
            o(this, ft).focusElement(t, {
                preventScroll: !0
            });
            let i = this.calendar.type || "date";
            i === "date" ? this.calendar.startDate = S.parseDate(t.dataset.date) : i === "period" && (this.calendar.startDate ? this.calendar.endDate ? (this.calendar.startDate = S.parseDate(t.dataset.date),
            this.calendar.endDate = null) : this.calendar.endDate = S.parseDate(t.dataset.date) : this.calendar.startDate = S.parseDate(t.dataset.date))
        }
        );
        g(this, Di, new Date);
        g(this, Si, e => {
            if (!o(this, Jt) || o(this, Xt) || this.calendar.type === "date")
                return;
            let t = e.target
              , i = S.parseDate(t.dataset.date);
            this.shadowRoot.querySelectorAll(".calendar-week button").forEach(a => {
                let c = S.parseDate(a.dataset.date);
                c > o(this, Jt) && c < i ? a.classList.add("day--hover-in-between") : a.classList.remove("day--hover-in-between")
            }
            )
        }
        );
        g(this, cd, () => {
            !o(this, Jt) || o(this, Xt) || this.calendar.type === "date" || v(this, _t, Go).call(this)
        }
        );
        this.render = () => Maquette.h("div", {
            class: "calendar-day-panel",
            afterCreate: () => {
                o(this, ft).updateElements()
            }
        }, Maquette.h("div", {
            class: "calendar-header--days"
        }, v(this, _t, $0).call(this)), this.renderDayPanel());
        this.renderDayPanel = () => {
            let e = []
              , i = new Date(this.displayDateAsDate.getFullYear(),this.displayDateAsDate.getMonth(),1).getDay() - this.firstDayOfWeek;
            i < 0 && (i = 7 + i);
            ...
            return Maquette.h("div", {
                    ...
                    });
                {
                    let C = this.displayDateAsDate.getFullYear().toString()
                      , D = (this.displayDateAsDate.getMonth() + 1).toString().padStart(2, "0")
                      , I = x.toString().padStart(2, "0")
                      , H = S.parseDate(`${C}-${D}-${I}`)
                      , ne = `${C}-${D}-${I}` === S.dateToYYYY_MM_DD(o(this, Di))
                      , ue = this.calendar.inRange(H, 0)
                      , U = !1
                      , re = !1;
                    if (this.calendar.type === "date") {
                        let F = this.calendar.startDate ? S.dateToYYYY_MM_DD(this.calendar.startDate) : null;
                        F && (U = F === `${C}-${D}-${I}`)
                    } else if (this.calendar.type === "period") {
                        let F = this.calendar.startDate ? S.dateToYYYY_MM_DD(this.calendar.startDate) : null
                          , nt = this.calendar.endDate ? S.dateToYYYY_MM_DD(this.calendar.endDate) : null;
                        if (F && nt && (U = F === `${C}-${D}-${I}` || nt === `${C}-${D}-${I}`),
                        F && !nt && (U = F === `${C}-${D}-${I}`),
                        F && nt) {
                            let q = S.parseDate(`${C}-${D}-${I}`);
                            re = q > this.calendar.startDate && q < this.calendar.endDate
                        }
                    }
                    return Maquette.h("button", {
                        onclick: o(this, Mi),
                        onmouseenter: o(this, Si),
                        onmouseleave: o(this, cd),
                        classes: {
                            day: !0,
                            "panel-button": !0,
                            "day--is-today": ne,
                            "day--is-selected": U,
                            "day--is-in-between": re,
                            focus: !0
                        },
                        disabled: ue ? void 0 : "disabled",
                        "data-date": `${C}-${D}-${I}`,
                        key: `button-=${H.getTime()}-${k}-${A}`
                    }, x)
                }
            }
            ))))
    ...
    get displayDateAsDate() {
        return ye.fromAttribute(this.displayDate)
    }
    updated(e, t, i) {
        ...
        e === "value" && ($(this, Jt, this.calendar.startDate),
        $(this, Xt, this.calendar.endDate),
        o(this, Xt) && v(this, _t, Go).call(this))
    }
    focus(e) {
        requestAnimationFrame( () => {
            ...
            e.preventScroll = !0,
            o(this, ft).updateElements(),
            o(this, ft).focusElement(void 0, e)
        }
        )
    }
    connectedCallback() {
        super.connectedCallback(),
        this.addEventListener("mouseleave", o(this, cd))
    }
}
;
ft = new WeakMap,
...
$0 = function() {
    ...
    return Array.from({
        length: 7
    }, (i, a) => new Date(2024,8,a + 1 + e).toLocaleString(this.lang || "nl", {
        weekday: "short"
    })).map(i => Maquette.h("div", {
...
m([Property({
    ...
    reflect: !0
})], Be.prototype, "displayDate", 2),
m([Property({
    type: "object",
    reflect: !0,
    attribute: "min",
    converter: ye
})], Be.prototype, "minDate", 2),
m([Property({
    type: "object",
    reflect: !0,
    attribute: "max",
    converter: ye
})], Be.prototype, "maxDate", 2),
Be = m([CustomElementConfig({
    tagName: "pggm-calendar-day-panel"
})], Be);
var Ti = () => Maquette.h("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24"
}, Maquette.h("path", {
...
var Nt, zi, S1 = class extends CustomElement {
    constructor() {
        super();
        g(this, Nt);
        g(this, zi, () => {
        ...
        this.render = () => {
            ...
            for (let c = 0; c < e.length; c += t)
                i.push(e.slice(c, c + t));
            let a = 0;
            return Maquette.h("div", {
                class: "calendar-month-panel",
                afterCreate: () => o(this, Nt).updateElements()
            }, Maquette.h("div", {
                ...
                class: "sr-only"
            }, this.calendar.closeLabel))), i.map(c => Maquette.h("div", {
                class: "calendar-month-row"
            }, c.map( (h, f) => {
                let w = new Date(this.calendar.displayDate.getFullYear(),a,1);
                a++;
                let k = this.calendar.inRange(w, 1);
                return Maquette.h("button", {
                    class: "month panel-button",
                    disabled: k ? void 0 : "",
                    onclick: () => {
                        this.calendar.displayDate = w,
                        this.calendar.activePanel = "day"
                    }
                }, h)
            }
    ...
    focus(e) {
        requestAnimationFrame( () => {
            ...
            e.preventScroll = !0,
            o(this, Nt).updateElements(),
            o(this, Nt).focusElement(void 0, e)
        }
        )
    }
    get calendar() {
...
S1 = m([CustomElementConfig({
    tagName: "pggm-calendar-month-panel"
})], S1);
var Bt, Li, Ft, gd = class extends CustomElement {
    constructor() {
        super();
        g(this, Bt);
        g(this, Li, () => {
        ...
        this.updateFoucsGroup = () => {
            requestAnimationFrame( () => {
                o(this, Bt).updateElements()
            }
            )
        }
        ;
        this.render = () => {
            o(this, Ft) || $(this, Ft, this.calendar.displayDate.getFullYear());
            let e = o(this, Ft) - 4
              , t = e + 8
              , i = Array.from({
                length: t - e + 1
    ...
    focus(e) {
        requestAnimationFrame( () => {
            ...
            e.preventScroll = !0,
            o(this, Bt).updateElements(),
            o(this, Bt).focusElement(void 0, e)
        }
        )
    }
    get calendar() {
...
Ft = new WeakMap,
gd.style = zt + D1,
gd = m([CustomElementConfig({
    tagName: "pggm-calendar-year-panel"
})], gd);
var x0 = ["date", "period"], w0 = ["day", "month"], n2 = {
    fromAttribute: r => {
        if (!r)
            return null;
        if (r.indexOf(",") > 0) {
            let e = r.split(",", 2)[0]
              ...
              , i = S.parseDate(e)
              , a = S.parseDate(t);
            return Number.isNaN(i.getTime()) || Number.isNaN(a.getTime()) ? null : i > a ? [t, e] : [e, t]
        }
        let s = S.parseDate(r);
        return Number.isNaN(s.getTime()) ? null : r
    }
    ,
    toAttribute: r => r ? Array.isArray(r) ? r.join(",") : r : null
}, ye = {
    fromAttribute: r => {
        if (r)
            return S.parseDate(r)
    }
    ,
    toAttribute: r => {
        if (!(!r || !(r instanceof Date)))
            return S.dateToYYYY_MM_DD(r)
    }
}, k0 = r => Maquette.h("svg", {
    classes: {
        chevron: !0,
        "chevron-left": r === "left",
        "chevron-right": r === "right"
    },
    xmlns: "http://www.w3.org/2000/svg",
    width: "8",
    height: "14",
...
})), Fe, pd, Xe, bt, E0, C0, ud, S = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, Fe);
        g(this, Xe, null);
        ...
        this.render = () => Maquette.h("div", {
            ...
            class: "nav-button",
            onclick: () => v(this, Fe, C0).call(this)
        }, k0("left"), Maquette.h("span", {
            class: "sr-only"
        ...
        }, this.displayDate.toLocaleString(o(this, Fe, pd), {
            month: "long"
        })), Maquette.h("button", {
            ...
            class: "nav-button",
            onclick: () => v(this, Fe, E0).call(this)
        }, k0("right"), Maquette.h("span", {
            class: "sr-only"
            ...
            lang: o(this, Fe, pd),
            type: this.type,
            "display-date": ye.toAttribute(this.displayDate)
    ...
    static parseDate(e, t) {
        if (!e)
            return null;
        let i = (x, A) => new Date(A,x,0).getDate();
        t || (t = S.YYYY_MM_DD);
        let a = e.match(/(\d+)/g)
          , c = 0
          , h = {};
        if (t.replace(/(yyyy|dd|mm)/g, x => (h[x] = c++,
        "")),
        !a || a.length < 3)
            return null;
        let f = parseInt(a[h.mm], 10)
          , w = parseInt(a[h.dd], 10)
          , k = parseInt(a[h.yyyy], 10);
        return f - 1 > 11 || f - 1 < 0 || w === 0 || w > i(f, k) ? null : new Date(k,f - 1,w)
    }
    ...
    set startDate(e) {
        (o(this, Xe) ? o(this, Xe).valueOf() : null) !== e.valueOf() && ($(this, Xe, e),
        this.value = S.dateToYYYY_MM_DD(o(this, Xe)))
    }
    get endDate() {
        return o(this, bt)
    }
    set endDate(e) {
        let t = o(this, bt) ? o(this, bt).valueOf() : null;
        e ? t !== e.valueOf() && ($(this, bt, e),
        this.value = [S.dateToYYYY_MM_DD(o(this, Xe)), S.dateToYYYY_MM_DD(o(this, bt))]) : ($(this, bt, e),
        this.value = S.dateToYYYY_MM_DD(o(this, Xe)))
    }
    inRange(e, t) {
        t || (t = 0);
        let i = !0;
        return t === 0 && this.minDate && e < this.minDate && (i = !1),
        t === 0 && this.maxDate && e > this.maxDate && (i = !1),
        t === 1 && this.minDate && e < new Date(this.minDate.getFullYear(),this.minDate.getMonth(),1) && (i = !1),
        t === 1 && this.maxDate && e > new Date(this.maxDate.getFullYear(),this.maxDate.getMonth() + 1,0) && (i = !1),
        t === 2 && this.minDate && e.getFullYear() < this.minDate.getFullYear() && (i = !1),
        t === 2 && this.maxDate && e.getFullYear() > this.maxDate.getFullYear() && (i = !1),
        i
    }
    shouldUpdate(e, t, i) {
        return e === "type" && i && !x0.includes(i) ? (console.warn(`Invalid value for type: ${i}, valid values are: ${x0.join(",")}`),
        !1) : e === "picker" && i && !w0.includes(i) ? (console.warn(`Invalid value for picker: ${i}, valid values are: ${w0.join(",")}`),
        !1) : !0
    }
    updated(e, t, i) {
        if (e === "value" && (Array.isArray(i) ? (this.startDate = ye.fromAttribute(i[0]),
        this.endDate = ye.fromAttribute(i[1])) : (this.startDate = ye.fromAttribute(i),
        this.endDate = null),
    ...
    connectedCallback() {
        super.connectedCallback(),
        this.addEventListener("keydown", o(this, ud))
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        this.removeEventListener("keydown", o(this, ud))
    }
    focus(e) {
...
ud = new WeakMap,
S.style = v0,
S.YYYY_MM_DD = "yyyy-mm-dd",
m([Query("pggm-calendar-day-panel")], S.prototype, "dayPanelElement", 2),
m([Query("pggm-calendar-month-panel")], S.prototype, "monthPanelElement", 2),
m([Query("pggm-calendar-year-panel")], S.prototype, "yearPanelElement", 2),
m([Property({
    type: "object",
    converter: ye
})], S.prototype, "displayDate", 2),
m([Property({
    type: "object",
    reflect: !0,
    attribute: "value",
...
var md, T1, hd, fd, de = class extends CustomElement {
    constructor() {
        ...
        this.render = () => Maquette.h("div", {
            classes: {
                ...
                "pggm-checkbox--error": o(this, md) && !this.validity.valid
            }
        }, Maquette.h("input", {
    ...
    connectedCallback() {
        super.connectedCallback(),
        this.tabIndex = this.disabled ? -1 : 0,
        this.addEventListener("click", o(this, T1)),
        this.addEventListener("keydown", o(this, hd)),
        this.addEventListener("blur", o(this, fd))
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        this.removeEventListener("click", o(this, T1)),
        this.removeEventListener("keydown", o(this, hd)),
        this.removeEventListener("blur", o(this, fd))
    }
}
;
md = new WeakMap,
...
m([Query("input")], de.prototype, "inputElement", 2),
de = m([CustomElementConfig({
    tagName: de.TAG_NAME
})], de);
var M0 = `.pggm-checkbox-group{gap:var(--pggm-checkbox-group-row-gap)}.pggm-checkbox-group,.pggm-checkbox-group__options{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.pggm-checkbox-group__options{gap:var(--pggm-radio-group-row-gap)}#GroupOptions ::slotted(:not(pggm-checkbox)){display:none;visibility:hidden}
`;
var Ii, Ni, Re = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, Ii, e => {
            let i = e.target.assignedNodes()
              , a = i.filter(c => c.nodeType === Node.TEXT_NODE).map(c => c.textContent.trim()).join(" ");
            a && a.length > 0 && (this.label = a),
            i.filter(c => c.nodeType === Node.TEXT_NODE).forEach(c => {
                var h;
    ...
    updated(e, t, i) {
        e === "disabled" && o(this, Ni).call(this, i)
    }
    render() {
        return Maquette.h("div", {
            classes: {
...
var T0 = (r, s, e) => (typeof s == "string" && (s = Maquette.h("div", {
    innerHTML: s
})),
new Promise( (t, i) => {
    ...
    let c = k => {
        let x = k.target.getAttribute("data-button");
        requestAnimationFrame( () => {
            var A;
      ...
      , h = k => {
        k.addEventListener("openDialog", () => {
            var x;
            (x = k.querySelector("button[data-button]")) == null || x.focus()
        }
        ),
        k.addEventListener("cancelDialog", x => {
            i(),
            requestAnimationFrame( () => {
                var A;
                (A = x.target) == null || A.remove()
            }
            )
        }
        ),
        k.addEventListener("closeDialog", x => {
            requestAnimationFrame( () => {
                var A;
                (A = x.target) == null || A.remove()
            }
      ...
      , f = () => Maquette.h("pggm-dialog", {
        ...
        slot: "header"
    }, r), Maquette.h("div", null, s), e.map( (k, x) => Maquette.h("button", {
        appearance: x === 0 ? "primary" : "secondary",
        is: "pggm-button",
        "data-button": k,
        slot: "action",
        onclick: c
...
var z0 = (r, s, e, t) => (typeof s == "string" ? s = Maquette.h("form", {
    innerHTML: s
...
new Promise( (i, a) => {
    ...
    let h = x => {
        if (x.target.getAttribute("data-button") === e) {
            let I = x.target.closest("pggm-dialog").querySelector("form");
            if (I.checkValidity() === !1) {
                I.reportValidity();
                return
            }
            let H = new FormData(I);
            i(H)
        } else
            a();
        requestAnimationFrame( () => {
            var C;
            x.target && ((C = x.target.closest("pggm-dialog")) == null || C.close()),
            i(null)
        }
        )
    }
      , f = x => {
        let A = x.querySelector("form");
        A.method = "dialog",
        A.addEventListener("submit", C => {
            C.preventDefault();
            let D = new FormData(A);
            i(D),
            requestAnimationFrame( () => {
                x.remove()
            }
        ...
        x.addEventListener("openDialog", () => {
            var C;
            (C = Array.from(A.elements).filter(D => !!D.focus)[0]) == null || C.focus()
        }
        ),
        x.addEventListener("cancelDialog", C => {
            a(),
            requestAnimationFrame( () => {
                var D;
                (D = C.target) == null || D.remove()
            }
            )
        }
        ),
        x.addEventListener("closeDialog", C => {
            requestAnimationFrame( () => {
                var D;
                (D = C.target) == null || D.remove()
            }
      ...
      , w = () => Maquette.h("pggm-dialog", {
        modal: "modal",
        open: "open",
        afterCreate: f
    }, Maquette.h("div", {
        slot: "header"
    }, r), Maquette.h("div", null, s), [e, t].map( (x, A) => Maquette.h("button", {
    ...
    Maquette.createProjector().replace(c, w)
}
));
var bd, Bi, z1, L0, I0, xe = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, z1);
        this.render = () => {
    ...
    updated(e, t, i) {
        e === "open" && requestAnimationFrame( () => {
            i === !0 ? v(this, z1, L0).call(this, this.modal) : v(this, z1, I0).call(this)
        }
        )
    }
    close() {
...
xe.confirm = T0,
xe.prompt = z0,
m([Query(".dialog-close-button")], xe.prototype, "dialogCloseButton", 2),
m([Property({
    type: "string",
    attribute: "close-label",
    reflect: !0
})], xe.prototype, "closeLabel", 2),
m([Property({
    type: "boolean",
    attribute: "modal",
    reflect: !0
})], xe.prototype, "modal", 2),
m([Property({
    type: "boolean",
    attribute: "open",
    reflect: !0
})], xe.prototype, "open", 2),
xe = m([CustomElementConfig({
    tagName: "pggm-dialog"
})], xe);
var N0 = `:host{display:none;visibility:hidden}:host([visible]){display:block;visibility:visible}.pggm-error{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:middle;-ms-flex-align:middle;align-items:middle;color:var(--pggm-form-field-error-message-color);font-family:var(--pggm-form-field-error-message-font-family);font-size:var(--pggm-form-field-error-message-font-size);font-weight:var(--pggm-form-field-error-message-font-weight);gap:var(--pggm-form-field-error-message-row-gap);margin-bottom:var(--pggm-form-field-error-message-margin-block-start)}.pggm-error__icon{height:var(--pggm-form-field-error-message-icon-size);width:var(--pggm-form-field-error-message-icon-size)}.pggm-error__icon--hidden{visibility:hidden}
`;
var B0 = `<svg
  xmlns="http://www.w3.org/2000/svg"
  width="24"
...
var p2 = ["badInput", "customError", "patternMismatch", "rangeOverflow", "rangeUnderflow", "stepMismatch", "tooLong", "tooShort", "typeMismatch", "valueMissing"], u2 = {
    fromAttribute: r => r ? r.split(" ").map(s => s.trim()).filter(s => p2.includes(s)) : null,
    toAttribute: r => !r || !r.join ? null : r.join(" ")
}, j, _e, F0, R0, L1, I1, Fi, Ri, he = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, _e);
        this.visible = !1;
        ...
        g(this, L1, e => {
            e.preventDefault(),
            o(this, j).setAttribute("aria-invalid", o(this, j).validity.valid ? "false" : "true");
            let t = v(this, _e, R0).call(this);
            this.visible = t,
            t && e.preventDefault()
        }
        );
        g(this, I1, e => {
            if (!o(this, j))
                return;
            let t = !1;
            for (let i of this.validity)
                if (o(this, j).validity[i]) {
                    t = !0;
                    break
                }
            this.visible = t,
        ...
        g(this, Ri, () => {
            ...
            for (e.push(this); i && i.tagName === "PGGM-ERROR-MESSAGE"; )
                e.push(i),
    ...
    updated(e, t, i) {
        e === "visible" && i === !0 ? this.hasAttribute("visible") || this.setAttribute("visible", "") : e === "visible" && i === !1 && this.hasAttribute("visible") && this.removeAttribute("visible");
        let a = this.getRootNode();
        e === "for" && a && i && v(this, _e, Fi).call(this)
    }
    render() {
        return Maquette.h("div", {
            class: "pggm-error",
            afterUpdate: o(this, Ri)
        }, Maquette.h("span", {
            classes: {
                "pggm-error__icon": !0
            },
    ...
    connectedCallback() {
        super.connectedCallback(),
        v(this, _e, Fi).call(this)
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        o(this, j) && (o(this, j).removeEventListener("invalid", o(this, L1)),
        he.allUpdateEvents.forEach(e => {
            o(this, j).removeEventListener(e, o(this, I1))
        }
        ),
        $(this, j, null))
    }
...
F0 = function(e) {
    o(this, j) && (o(this, j).removeEventListener("invalid", o(this, L1)),
    he.allUpdateEvents.forEach(t => {
        o(this, j).removeEventListener(t, o(this, I1))
    }
    )),
    $(this, j, e),
    o(this, j).addEventListener("invalid", o(this, L1)),
    he.allUpdateEvents.forEach(t => {
        o(this, j).addEventListener(t, o(this, I1))
    }
    )
}
,
...
Fi = function() {
    ...
    if (e && !o(this, j)) {
        ...
        t ? v(this, _e, F0).call(this, t) : setTimeout( () => {
            v(this, _e, Fi).call(this)
        }
        , 500)
    }
...
Ri = new WeakMap,
he.style = N0,
he.allUpdateEvents = ["blur", "change"],
m([Property({
    type: "boolean",
    attribute: "visible",
    reflect: !0
})], he.prototype, "visible", 2),
m([Property({
    type: "string",
    attribute: "for",
    reflect: !0
...
var vt, Ae, Jo, H0, Y0, Xo, Oi, Rt = class extends CustomElement {
    constructor() {
        ...
        g(this, Oi, e => {
            var i;
            ((i = e.target) == null ? void 0 : i.name) === "" && v(this, Ae, Xo).call(this)
        }
        )
    }
    render() {
        return Maquette.h("div", {
            classes: {
                "pggm-fieldset": !0,
                "pggm-fieldset--disabled": o(this, Ae, Jo)
            }
    ...
    connectedCallback() {
        super.connectedCallback(),
        this.shadowRoot.addEventListener("slotchange", o(this, Oi)),
        v(this, Ae, Xo).call(this)
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        v(this, Ae, Y0).call(this)
    }
}
;
vt = new WeakMap,
...
Xo = function() {
    ...
    for (let[t,i] of o(this, vt))
        e.includes(t) || (i.disconnect(),
        o(this, vt).delete(t))
}
,
Oi = new WeakMap,
...
var v2 = new Set(["top", "bottom"]);
function Ot(r) {
    return v2.has(t1(r)) ? "y" : "x"
}
function en(r) {
    return W0(Ot(r))
}
function q0(r, s, e) {
    ...
    let t = yd(r)
      , i = en(r)
      , a = _o(i)
      , c = i === "x" ? t === (e ? "end" : "start") ? "right" : "left" : t === "start" ? "bottom" : "top";
    return s.reference[a] > s.floating[a] && (c = vd(c)),
    [c, vd(c)]
}
function K0(r) {
    let s = vd(r);
...
function Hi(r) {
    return r.replace(/start|end/g, s => b2[s])
}
var V0 = ["left", "right"]
  , j0 = ["right", "left"]
  , $2 = ["top", "bottom"]
...
function U0(r, s, e, t) {
    let i = yd(r)
      , a = x2(t1(r), e === "start", t);
    return i && (a = a.map(c => c + "-" + i),
    s && (a = a.concat(a.map(Hi)))),
    a
}
function vd(r) {
    return r.replace(/left|right|bottom|top/g, s => f2[s])
}
function w2(r) {
    return Ie({
        top: 0,
...
function d1(r) {
    let {x: s, y: e, width: t, height: i} = r;
    return {
        width: t,
        height: i,
        top: e,
...
function Q0(r, s, e) {
    let {reference: t, floating: i} = r, a = Ot(s), c = en(s), h = _o(c), f = t1(s), w = a === "y", k = t.x + t.width / 2 - i.width / 2, x = t.y + t.height / 2 - i.height / 2, A = t[h] / 2 - i[h] / 2, C;
    switch (f) {
    case "top":
        C = {
            x: k,
...
var G0 = (r, s, e) => G(null, null, function*() {
    let {placement: t="bottom", strategy: i="absolute", middleware: a=[], platform: c} = e
      , h = a.filter(Boolean)
      , f = yield c.isRTL == null ? void 0 : c.isRTL(s)
      , w = yield c.getElementRects({
        reference: r,
        floating: s,
        strategy: i
    })
    ...
    for (let I = 0; I < h.length; I++) {
        let {name: H, fn: ne} = h[I]
          , {x: ue, y: U, data: re, reset: F} = yield ne({
            x: k,
            y: x,
            initialPlacement: t,
            placement: A,
        ...
        F && D <= 50 && (D++,
        typeof F == "object" && (F.placement && (A = F.placement),
        F.rects && (w = F.rects === !0 ? yield c.getElementRects({
            reference: r,
            floating: s,
            strategy: i
        }) : F.rects),
...
function J0(r, s) {
    return G(this, null, function*() {
        var e;
        s === void 0 && (s = {});
        let {x: t, y: i, platform: a, rects: c, elements: h, strategy: f} = r
          , {boundary: w="clippingAncestors", rootBoundary: k="viewport", elementContext: x="floating", altBoundary: A=!1, padding: C=0} = Pi(s, r)
          , D = Z0(C)
          , H = h[A ? x === "floating" ? "reference" : "floating" : x]
          , ne = d1(yield a.getClippingRect({
            element: (e = yield a.isElement == null ? void 0 : a.isElement(H)) == null || e ? H : H.contextElement || (yield a.getDocumentElement == null ? void 0 : a.getDocumentElement(h.floating)),
            boundary: w,
            rootBoundary: k,
            strategy: f
        }))
          ...
          , re = (yield a.isElement == null ? void 0 : a.isElement(U)) ? (yield a.getScale == null ? void 0 : a.getScale(U)) || {
            x: 1,
            y: 1
        } : {
            x: 1,
          ...
          , F = d1(a.convertOffsetParentRelativeRectToViewportRelativeRect ? yield a.convertOffsetParentRelativeRectToViewportRelativeRect({
            elements: h,
            rect: ue,
            offsetParent: U,
            strategy: f
        ...
        return {
            top: (ne.top - F.top + D.top) / re.y,
            bottom: (F.bottom - ne.bottom + D.bottom) / re.y,
            left: (ne.left - F.left + D.left) / re.x,
            right: (F.right - ne.right + D.right) / re.x
        }
    })
}
var X0 = function(r) {
    return r === void 0 && (r = {}),
    {
        ...
        fn(e) {
            return G(this, null, function*() {
                var t, i;
                let {placement: a, middlewareData: c, rects: h, initialPlacement: f, platform: w, elements: k} = e
                  , ae = Pi(r, e)
                  , {mainAxis: x=!0, crossAxis: A=!0, fallbackPlacements: C, fallbackStrategy: D="bestFit", fallbackAxisSideDirection: I="none", flipAlignment: H=!0} = ae
                  , ne = Gn(ae, ["mainAxis", "crossAxis", "fallbackPlacements", "fallbackStrategy", "fallbackAxisSideDirection", "flipAlignment"]);
                if ((t = c.arrow) != null && t.alignmentOffset)
                    return {};
                let ue = t1(a)
                  , U = Ot(f)
                  , re = t1(f) === f
                  , F = yield w.isRTL == null ? void 0 : w.isRTL(k.floating)
                  , nt = C || (re || !H ? [vd(f)] : K0(f))
                  , q = I !== "none";
                !C && q && nt.push(...U0(f, H, I, F));
                let ci = [f, ...nt]
                  , W = yield J0(e, ne)
                  , rt = []
                  , E = ((i = c.flip) == null ? void 0 : i.overflows) || [];
                if (x && rt.push(W[ue]),
                A) {
                    let Ke = q0(a, h, F);
                    rt.push(W[Ke[0]], W[Ke[1]])
                }
                if (E = [...E, {
                    placement: a,
                    overflows: rt
                ...
                !rt.every(Ke => Ke <= 0)) {
                    var z, _;
                    let Ke = (((z = c.flip) == null ? void 0 : z.index) || 0) + 1
                      , Mt = ci[Ke];
                    if (Mt && (!(A === "alignment" ? U !== Ot(Mt) : !1) || E.every(se => Ot(se.placement) === U ? se.overflows[0] > 0 : !0)))
                        return {
                            data: {
                                index: Ke,
                                overflows: E
                    ...
                    let Ue = (_ = E.filter(Ze => Ze.overflows[0] <= 0).sort( (Ze, se) => Ze.overflows[1] - se.overflows[1])[0]) == null ? void 0 : _.placement;
                    if (!Ue)
                        switch (D) {
                        case "bestFit":
                            {
                                var at;
                                let Ze = (at = E.filter(se => {
                                    if (q) {
                                        let le = Ot(se.placement);
                                        return le === U || le === "y"
                                    }
                                    return !0
                                }
                                ).map(se => [se.placement, se.overflows.filter(le => le > 0).reduce( (le, Z) => le + Z, 0)]).sort( (se, le) => se[1] - le[1])[0]) == null ? void 0 : at[0];
                                Ze && (Ue = Ze);
                                break
                            }
...
var k2 = new Set(["left", "top"]);
function E2(r, s) {
    return G(this, null, function*() {
        let {placement: e, platform: t, elements: i} = r
          , a = yield t.isRTL == null ? void 0 : t.isRTL(i.floating)
          , c = t1(e)
          , h = yd(e)
          , f = Ot(e) === "y"
          , w = k2.has(c) ? -1 : 1
          , k = a && f ? -1 : 1
          , x = Pi(s, r)
          , {mainAxis: A, crossAxis: C, alignmentAxis: D} = typeof x == "number" ? {
            mainAxis: x,
            crossAxis: 0,
            alignmentAxis: null
        } : {
        ...
        return h && typeof D == "number" && (C = h === "end" ? D * -1 : D),
        f ? {
            x: C * k,
            y: A * w
        } : {
        ...
        fn(e) {
            return G(this, null, function*() {
                ...
                let {x: a, y: c, placement: h, middlewareData: f} = e
                  , w = yield E2(e, r);
                return h === ((t = f.offset) == null ? void 0 : t.placement) && (i = f.arrow) != null && i.alignmentOffset ? {} : {
                    x: a + w.x,
                    y: c + w.y,
                    data: A1(Ie({}, w), {
                        placement: h
...
function i1(r) {
    return tr(r) ? (r.nodeName || "").toLowerCase() : "#document"
}
function fe(r) {
    var s;
...
function et(r) {
    var s;
    return (s = (tr(r) ? r.ownerDocument : r.document) || window.document) == null ? void 0 : s.documentElement
}
function tr(r) {
    return ji() ? r instanceof Node || r instanceof fe(r).Node : !1
}
function Me(r) {
    return ji() ? r instanceof Element || r instanceof fe(r).Element : !1
}
function He(r) {
    return ji() ? r instanceof HTMLElement || r instanceof fe(r).HTMLElement : !1
}
function er(r) {
    return !ji() || typeof ShadowRoot == "undefined" ? !1 : r instanceof ShadowRoot || r instanceof fe(r).ShadowRoot
}
var C2 = new Set(["inline", "contents"]);
function N1(r) {
    let {overflow: s, overflowX: e, overflowY: t, display: i} = De(r);
    return /auto|scroll|overlay|hidden|clip/.test(s + t + e) && !C2.has(i)
}
var A2 = new Set(["table", "td", "th"]);
function dr(r) {
    return A2.has(i1(r))
}
var M2 = [":popover-open", ":modal"];
function xd(r) {
    return M2.some(s => {
        try {
            return r.matches(s)
...
var D2 = ["transform", "translate", "scale", "rotate", "perspective"]
  , S2 = ["transform", "translate", "scale", "rotate", "perspective", "filter"]
  , T2 = ["paint", "layout", "strict", "content"];
function Wi(r) {
    let s = qi()
      , e = Me(r) ? De(r) : r;
    return D2.some(t => e[t] ? e[t] !== "none" : !1) || (e.containerType ? e.containerType !== "normal" : !1) || !s && (e.backdropFilter ? e.backdropFilter !== "none" : !1) || !s && (e.filter ? e.filter !== "none" : !1) || S2.some(t => (e.willChange || "").includes(t)) || T2.some(t => (e.contain || "").includes(t))
}
function ir(r) {
    let s = $t(r);
    for (; He(s) && !o1(s); ) {
...
var z2 = new Set(["html", "body", "#document"]);
function o1(r) {
    return z2.has(i1(r))
}
function De(r) {
...
function $t(r) {
    if (i1(r) === "html")
        return r;
    let s = r.assignedSlot || r.parentNode || er(r) && r.host || et(r);
    return er(s) ? s.host : s
}
function or(r) {
    let s = $t(r);
    return o1(s) ? r.ownerDocument ? r.ownerDocument.body : r.body : He(s) && N1(s) ? s : or(s)
}
function Vi(r, s, e) {
    var t;
    s === void 0 && (s = []),
    e === void 0 && (e = !0);
    let i = or(r)
      , a = i === ((t = r.ownerDocument) == null ? void 0 : t.body)
      , c = fe(i);
    if (a) {
        let h = Ki(c);
        return s.concat(c, c.visualViewport || [], N1(i) ? i : [], h && e ? Vi(h) : [])
    }
    return s.concat(i, Vi(i, [], e))
}
function Ki(r) {
...
function B1(r) {
    ...
    let e = s.getBoundingClientRect()
      , {width: t, height: i, $: a} = sr(s)
      , c = (a ? $d(e.width) : e.width) / t
      , h = (a ? $d(e.height) : e.height) / i;
...
function kd(r, s, e, t) {
    ...
    let i = r.getBoundingClientRect()
      , a = lr(r)
      , c = Oe(1);
    s && (t ? Me(t) && (c = B1(t)) : c = B1(r));
    let h = I2(a, e, t) ? cr(a) : Oe(0)
      , f = (i.left + h.x) / c.x
      , w = (i.top + h.y) / c.y
      , k = i.width / c.x
      , x = i.height / c.y;
    if (a) {
        ...
        for (; I && t && C !== D; ) {
            let H = B1(I)
              ...
              , ue = De(I)
              , U = ne.left + (I.clientLeft + parseFloat(ue.paddingLeft)) * H.x
              , re = ne.top + (I.clientTop + parseFloat(ue.paddingTop)) * H.y;
            f *= H.x,
            w *= H.y,
            k *= H.x,
            x *= H.y,
...
function Ui(r, s) {
    let e = wd(r).scrollLeft;
    return s ? s.left + e : kd(et(r)).left + e
}
function gr(r, s) {
    let e = r.getBoundingClientRect()
      , t = e.left + s.scrollLeft - Ui(r, e)
      , i = e.top + s.scrollTop;
    return {
        x: t,
        y: i
...
function N2(r) {
    let {elements: s, rect: e, offsetParent: t, strategy: i} = r
      , a = i === "fixed"
      , c = et(t)
      , h = s ? xd(s.floating) : !1;
    if (t === c || h && a)
    ...
    let f = {
      ...
      , k = Oe(0)
      , x = He(t);
    if ((x || !x && !a) && ((i1(t) !== "body" || N1(c)) && (f = wd(t)),
    He(t))) {
        let C = kd(t);
        w = B1(t),
    ...
    let A = c && !x && !a ? gr(c, f) : Oe(0);
    return {
        width: e.width * w.x,
        height: e.height * w.y,
        x: e.x * w.x - f.scrollLeft * w.x + k.x + A.x,
        y: e.y * w.y - f.scrollTop * w.y + k.y + A.y
    }
}
function B2(r) {
...
function F2(r) {
    let s = et(r)
      ...
      , i = e1(s.scrollWidth, s.clientWidth, t.scrollWidth, t.clientWidth)
      , a = e1(s.scrollHeight, s.clientHeight, t.scrollHeight, t.clientHeight)
      , c = -e.scrollLeft + Ui(r)
      , h = -e.scrollTop;
    return De(t).direction === "rtl" && (c += e1(s.clientWidth, t.clientWidth) - i),
    {
        width: i,
        height: a,
        x: c,
...
function R2(r, s) {
    ...
    if (w <= 0) {
        let k = t.ownerDocument
          ...
          , D = Math.abs(t.clientWidth - x.clientWidth - C);
        D <= nr && (a -= D)
    } else
        w <= nr && (a += w);
    return {
...
var O2 = new Set(["absolute", "fixed"]);
function H2(r, s) {
    let e = kd(r, !0, s === "fixed")
      , t = e.top + r.clientTop
      , i = e.left + r.clientLeft
      , a = He(r) ? B1(r) : Oe(1)
      , c = r.clientWidth * a.x
      , h = r.clientHeight * a.y
      , f = i * a.x
      , w = t * a.y;
    return {
        width: c,
...
function pr(r, s) {
    let e = $t(r);
    return e === s || !Me(e) || o1(e) ? !1 : De(e).position === "fixed" || pr(e, s)
}
function Y2(r, s) {
    let e = s.get(r);
    if (e)
        return e;
    let t = Vi(r, [], !1).filter(h => Me(h) && i1(h) !== "body")
      , i = null
    ...
    for (; Me(c) && !o1(c); ) {
        let h = De(c)
          , f = Wi(c);
        !f && h.position === "fixed" && (i = null),
        (a ? !f && !i : !f && h.position === "static" && !!i && O2.has(i.position) || N1(c) && !f && pr(r, c)) ? t = t.filter(k => k !== c) : i = h,
        c = $t(c)
    }
    return s.set(r, t),
    t
...
function P2(r) {
    let {element: s, boundary: e, rootBoundary: t, strategy: i} = r
      , c = [...e === "clippingAncestors" ? xd(s) ? [] : Y2(s, this._c) : [].concat(e), t]
      , h = c[0]
      , f = c.reduce( (w, k) => {
        let x = rr(s, k, i);
        return w.top = e1(x.top, w.top),
        w.right = Yi(x.right, w.right),
        w.bottom = Yi(x.bottom, w.bottom),
        w.left = e1(x.left, w.left),
        w
    }
    , rr(s, h, i));
    return {
...
function j2(r, s, e) {
    ...
    if (t || !t && !a)
        ...
        t) {
            ...
            i && w();
    a && !t && i && w();
    let k = i && !t && !a ? gr(i, h) : Oe(0)
      , x = c.left + h.scrollLeft - f.x - k.x
...
function tn(r) {
    return De(r).position === "static"
}
function ar(r, s) {
    if (!He(r) || De(r).position === "fixed")
        return null;
    if (s)
        return s(r);
    let e = r.offsetParent;
    return et(r) === e && (e = e.ownerDocument.body),
    e
}
function ur(r, s) {
    let e = fe(r);
    ...
    for (; t && dr(t) && tn(t); )
        t = ar(t, s);
    return t && o1(t) && tn(t) && !Wi(t) ? e : t || ir(r) || e
}
var W2 = function(r) {
    return G(this, null, function*() {
        let s = this.getOffsetParent || ur
          , e = this.getDimensions
          , t = yield e(r.floating);
        return {
            reference: j2(r.reference, yield s(r.floating), r.strategy),
            floating: {
                x: 0,
                y: 0,
                width: t.width,
...
var Yt = (r, s, e) => {
    ...
    return G0(r, s, A1(Ie({}, i), {
        platform: a
    }))
}
;
var hr = ["primary", "secondary", "tertiary"]
  , fr = ["button", "dropzone", "both"];
function U2() {
    let r = navigator == null ? void 0 : navigator.platform;
    return ["iPad Simulator", "iPhone Simulator", "iPod Simulator", "iPad", "iPhone", "iPod"].includes(r)
}
var Z2 = {
    fromAttribute: r => r ? r.split(",").map(s => s.trim()).filter(s => s) : [],
    toAttribute: r => !r || !r.join ? "" : r.join(", ")
}, J, we, L, br, vr, $r, n1, yr, xr, Zi, F1, Pt, Qi, Gi, Ji, tt, Xi, _i, Ed, eo, to, R1, Y = class extends CustomElement {
    constructor() {
        var e;
        super();
        g(this, L);
        g(this, J, null);
        g(this, we, []);
        this.focusGroupController = new me(this,{
            direction: "vertical",
        ...
        this.multiple = !1;
        this.required = !1;
        g(this, Qi, () => this.mode === "dropzone" ? null : Maquette.h("div", null, Maquette.h("button", {
            disabled: this.disabled ? "disabled" : void 0,
            onclick: o(this, Ed),
            is: "pggm-button",
            id: "AddFileButton",
            appearance: this.butonAppearance,
            afterCreate: () => v(this, L, tt).call(this)
        }, this.button ? this.button : "Bestand toevoegen")));
        g(this, Gi, () => this.mode === "button" ? null : Maquette.h("div", {
            id: "Dropzone",
            class: "file-upload__dropzone",
            afterCreate: e => {
                ["dragenter", "dragover", "dragleave", "drop"].forEach(t => {
                    e.addEventListener(t, o(this, Xi))
                }
                )
            }
        }, Maquette.h("button", {
        ...
        g(this, Ji, () => Maquette.h("ul", {
            class: "file-upload__file-list"
        }, o(this, we).map( (e, t) => Maquette.h("li", {
            key: t
        }, e.error ? Maquette.h("pggm-error-message", {
            visible: "visible",
            afterCreate: () => v(this, L, tt).call(this),
            afterRemoved: () => v(this, L, tt).call(this)
        ...
        g(this, Xi, e => {
            ...
            t.type === "drop" && (Array.from(t.dataTransfer.files).forEach(i => {
                o(this, we).push({
                    file: i,
                    error: v(this, L, Zi).call(this, i),
                    removed: !1
                })
            }
            ),
            this.internals.setFormValue(o(this, L, n1)),
            v(this, L, tt).call(this),
            this.scheduleRender())
        }
        );
        ...
        g(this, Ed, e => {
            ...
            if (o(this, L, $r) && !0) {
                ...
                requestAnimationFrame( () => {
                    Yt(c, this.popoverFileMenu, {
                        placement: "bottom-start",
                        strategy: "absolute",
                        middleware: [Ht()]
                    }).then( ({x: h, y: f}) => {
                        let w = parseInt(getComputedStyle(this.popoverFileMenu).paddingLeft, 10) + parseInt(getComputedStyle(this.popoverFileMenu).paddingRight, 10);
                        this.popoverFileMenu.style.setProperty("--x", `${h}px`),
                        this.popoverFileMenu.style.setProperty("--y", `${f}px`),
                        this.popoverFileMenu.style.setProperty("--width", `${c.offsetWidth - w}px`)
                    }
                    )
                }
                );
            ...
            o(this, J).files = null,
            o(this, J).accept = this.accept.join(", "),
            (t = o(this, J)) == null || t.click()
        }
        );
        g(this, eo, e => {
            var t;
            o(this, F1) || ($(this, F1, !0),
            this.multiple || ($(this, we, []),
            this.internals.setFormValue(null)),
            Array.from((t = o(this, J)) == null ? void 0 : t.files).forEach(i => {
                o(this, we).push({
                    file: i,
                    error: v(this, L, Zi).call(this, i),
                    removed: !1
        ...
        g(this, to, e => {
            ...
            i && (requestAnimationFrame( () => {
                let a = parseInt(i.getAttribute("data-index"), 10);
                a > -1 && (o(this, we)[a].removed = !0,
                this.internals.setFormValue(o(this, L, n1)),
                this.renderNow())
            }
            ),
        ...
        g(this, R1, () => {
            $(this, Pt, !0),
            this.removeEventListener("invalid", o(this, R1)),
            this.scheduleRender()
        }
        );
        $(this, J, document.createElement("input")),
        o(this, J).type = "file",
        (e = o(this, J)) == null || e.addEventListener("change", o(this, eo)),
        o(this, J).addEventListener("cancel", t => {
            this.scheduleRender()
        }
        )
    }
    ...
    get files() {
        return o(this, we).filter(e => !e.removed).map(e => e.file)
    }
    get willValidate() {
    ...
    get validity() {
        ...
        e.valid = !1),
        o(this, we).some(t => t.error) && (e.badInput = !0,
        e.valid = !1),
    ...
    shouldUpdate(e, t, i) {
        return i && e === "button-appearance" && !hr.includes(i) ? (console.warn(`Invalid button appearance: ${i}. Valid appearances are: ${hr.join(", ")}`),
        !1) : i && e === "mode" && !fr.includes(i) ? (console.warn(`Invalid mode: ${i}. Valid modes are: ${fr.join(", ")}`),
        !1) : !0
    }
    updated(e, t, i) {
        e === "multiple" ? requestAnimationFrame( () => {
            o(this, J).multiple = this.multiple
        }
        ) : e === "disabled" ? requestAnimationFrame( () => {
            i ? this.internals.setFormValue(o(this, L, n1)) : this.internals.setFormValue(null)
        }
        ) : e === "required" && i === !0 && this.addFileButton && requestAnimationFrame( () => {
            v(this, L, tt).call(this)
        }
        )
    }
    connectedCallback() {
        super.connectedCallback(),
        !o(this, Pt) && this.addEventListener("invalid", o(this, R1))
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        o(this, Pt) || o(this, Pt) && this.removeEventListener("invalid", o(this, R1))
    }
    render() {
        return Maquette.h("div", {
            classes: {
            ...
            classes: {
                ...
                "file-upload__error--has-error": o(this, Pt) && this.internals.validity.valid === !1
            }
        }, Maquette.h("slot", {
            name: "error"
        })), o(this, Gi).call(this), o(this, Qi).call(this), Maquette.h("ul", {
            popover: "auto",
            ...
            onclick: e => {
                e.preventDefault(),
                o(this, J).setAttribute("capture", "environment"),
                o(this, J).accept = "image/jpg",
                o(this, J).click(),
                this.popoverFileMenu.togglePopover()
            }
        }, this.menuCapture ? this.menuCapture : "Maak een foto"))), o(this, Ji).call(this))
    }
}
;
J = new WeakMap,
...
,
$r = function() {
    return o(this, L, vr) && "capture"in o(this, J) && !U2()
}
,
n1 = function() {
    let e = new FormData;
    return this.files.forEach( (t, i) => {
...
yr = function(e) {
    if (!e)
        return !1;
    let t = this.accept.filter(i => i.startsWith(".")).map(i => i.slice(1));
    return this.accept.length > 0 ? !!t.find(i => i.trim().toLocaleLowerCase() === e) : !0
}
,
xr = function(e) {
    if (!e)
        return !1;
    let t = this.accept.filter(i => i.indexOf("/") > -1);
    if (this.accept.length > 0) {
        let i = t.find(a => a.trim().toLocaleLowerCase() === e);
        return i || (i = t.find(a => a.trim().toLocaleLowerCase() === e.split("/")[0] + "/*")),
        !!i
    }
    return !0
}
...
Zi = function(e) {
    let t = e.name.split(".").slice(1).pop() || null
      , a = v(this, L, yr).call(this, t.toLowerCase()) || v(this, L, xr).call(this, e.type) ? null : "Bestand is niet toegestaan";
...
tt = function() {
    ...
    if (e.valid)
        ...
        let i = ".file-upload__file-item--error button"
          , a = this.shadowRoot.querySelector(i)
          , c = h => {
...
m([Query("#AddFileButton")], Y.prototype, "addFileButton", 2),
m([Property({
    type: "string",
    attribute: "button",
    reflect: !0
})], Y.prototype, "button", 2),
m([Property({
    type: "string",
    attribute: "button-appearance",
    reflect: !0
})], Y.prototype, "butonAppearance", 2),
m([Property({
    type: "boolean",
    attribute: "disabled",
    reflect: !0
})], Y.prototype, "disabled", 2),
m([Query("#DropzoneButton")], Y.prototype, "dropzoneButton", 2),
m([Property({
    type: "string",
    attribute: "dropzone-label",
    reflect: !0
})], Y.prototype, "dropzoneLabel", 2),
m([Property({
    type: "number",
...
m([Property({
    ...
    attribute: "max-size",
    reflect: !0
})], Y.prototype, "maxSize", 2),
m([Property({
    type: "string",
    attribute: "menu-capture",
    reflect: !0
})], Y.prototype, "menuCapture", 2),
m([Property({
    type: "string",
    attribute: "menu-file",
    reflect: !0
})], Y.prototype, "menuFile", 2),
m([Property({
    type: "string",
    attribute: "mode",
    reflect: !0
...
var Vt = class {
    ...
    init() {
        [...this.constructor.attributes, "value", "disabled", "readonly"].forEach(e => {
            let t = e.replace(/-([a-z])/g, i => i[1].toUpperCase());
...
;
var H1, Ad, Md, be, O1, Dd, Sd, Td, Er, Cr, Ar, Cd = class extends Vt {
    constructor(e) {
        super(e);
        g(this, be);
        g(this, H1, !1);
        g(this, Ad, !1);
        g(this, Md, e => e ? e.replace(/[^\dA-Za-z]/g, "").replace(/(.{4})/g, "$1 ").trim().toLocaleUpperCase() : "");
        g(this, Dd, e => {
            let t = this.inputElement.selectionStart;
            this.inputElement.value = o(this, Md).call(this, this.inputElement.value),
            this.inputElement.value[t - 1] === " " && t++
        }
        );
        g(this, Sd, e => {
            e.key === "Enter" && (v(this, be, O1).call(this),
    ...
    set value(e) {
        this.inputElement.value = o(this, Md).call(this, e),
        v(this, be, O1).call(this)
    }
    get required() {
        return o(this, H1)
    ...
    set required(e) {
        o(this, H1) !== e && $(this, H1, typeof e == "string"),
        v(this, be, O1).call(this)
    }
    get disabled() {
        return o(this, Ad)
    ...
    disconnected() {
        super.disconnected(),
        this.inputElement.removeEventListener("input", o(this, Dd)),
        this.inputElement.removeEventListener("keydown", o(this, Sd)),
        this.inputElement.removeEventListener("blur", o(this, Td))
    }
    connected() {
        super.connected(),
        this.inputElement.addEventListener("input", o(this, Dd)),
        this.inputElement.addEventListener("keydown", o(this, Sd)),
        this.inputElement.addEventListener("blur", o(this, Td))
    }
}
;
H1 = new WeakMap,
...
O1 = function() {
    ...
    let e = v(this, be, Er).call(this);
    (e ? v(this, be, Cr).call(this, e) : !1) ? (this.internals.setValidity({}, "", this.inputElement),
...
,
Cr = function(e) {
    let t = (e[3] + e[1] + e[2]).replace(/[A-Z]/g, i => (i.charCodeAt(0) - 55).toString());
    return v(this, be, Ar).call(this, t) === 1
}
,
Ar = function(e) {
    let t = parseInt(e.slice(0, 2), 10), i;
    for (let a = 2; a < e.length; a += 7)
        i = String(t) + e.substring(a, a + 7),
        t = parseInt(i, 10) % 97;
    return t
}
,
Cd.attributes = ["required", "disabled"];
...
function _2() {
    ...
    (function(r) {
        (function() {
            ...
            function t(d, n) {
                ...
                d.La = function(p, u, b) {
                    for (var y = Array(arguments.length - 2), M = 2; M < arguments.length; M++)
                        y[M - 2] = arguments[M];
                    return n.prototype[u].apply(p, y)
                }
            }
            var i = class {
                constructor(d) {
            ...
            class A {
                constructor() {
                    var n = s.trustedTypes && s.trustedTypes.emptyHTML || "";
                    if (x !== x)
            ...
            ,
            q.prototype.get = function(d, n) {
                return E(this, d.g, n)
            }
            ,
            q.prototype.set = function(d, n) {
                ae(this, d.g, n)
            }
            ,
            q.prototype.add = function(d, n) {
                Ke(this, d.g, n)
            }
            ;
            function ci(d, n) {
                for (var l = D(d.m()), p = 0; p < l.length; p++) {
                    var u = l[p]
                      , b = u.g;
                    if (W(n, b)) {
                        d.g && delete d.g[u.g];
                        ...
                        if (u.l) {
                            ...
                            for (var M = 0; M < u.length; M++)
                                Ke(d, b, y ? u[M].clone() : u[M])
                        } else
                            u = rt(n, b),
                            y ? (y = rt(d, b)) ? ci(y, u) : ae(d, b, u.clone()) : ae(d, b, u)
                    }
                }
            }
            ...
            function at(d, n) {
                return d.j[n].l ? W(d, n) ? d.h[n].length : 0 : W(d, n) ? 1 : 0
            }
            function ae(d, n, l) {
                d.h[n] = l,
                d.g && (d.g[n] = l)
            ...
            function Mt(d, n) {
                var l = [], p;
                for (p in n)
                    p != 0 && l.push(new I(p,n[p]));
                return new C(d,l)
            }
            function Ue() {}
            Ue.prototype.g = function(d) {
                throw new d.h,
                Error("Unimplemented")
            }
            ,
            Ue.prototype.h = function(d, n) {
                if (d.h == 11 || d.h == 10)
                    return n instanceof q ? n : this.g(d.s.prototype.m(), n);
                if (d.h == 14)
                    return typeof n == "string" && Ze.test(n) && (d = Number(n),
                    0 < d) ? d : n;
                if (!d.o)
                    return n;
                if (d = d.s,
                d === String) {
                    if (typeof n == "number")
                        return String(n)
                } else if (d === Number && typeof n == "string" && (n === "Infinity" || n === "-Infinity" || n === "NaN" || Ze.test(n)))
                    return Number(n);
                return n
            }
            ;
            ...
            function le() {}
            t(le, se),
            le.prototype.h = function(d, n) {
                return d.h == 8 ? !!n : Ue.prototype.h.apply(this, arguments)
            }
            ,
            le.prototype.g = function(d, n) {
                return le.Fa.g.call(this, d, n)
            }
            ;
            function Z(d, n) {
            ...
            var Eo = {
              ...
              , ma = RegExp("[+\uFF0B]+")
              , td = RegExp("^[+\uFF0B]+")
              , hn = RegExp("([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9])")
              , ha = RegExp("[+\uFF0B0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]")
              , fa = /[\\\/] *x/
              , ba = RegExp("[^0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9A-Za-z#]+$")
              , va = /(?:.*?[A-Za-z]){3}.*/
              , $a = RegExp("^\\+([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]|[\\-\\.\\(\\)]?)*[0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]|[\\-\\.\\(\\)]?)*$")
              , ya = RegExp("^([A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]+((\\-)*[A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9])*\\.)*[A-Za-z]+((\\-)*[A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9])*\\.?$");
            function k1(d) {
                return "([0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]{1," + d + "})"
            }
            function fn() {
                return ";ext=" + k1("20") + "|[ \xA0\\t,]*(?:e?xt(?:ensi(?:o\u0301?|\xF3))?n?|\uFF45?\uFF58\uFF54\uFF4E?|\u0434\u043E\u0431|anexo)[:\\.\uFF0E]?[ \xA0\\t,-]*" + (k1("20") + "#?|[ \xA0\\t,]*(?:[x\uFF58#\uFF03~\uFF5E]|int|\uFF49\uFF4E\uFF54)[:\\.\uFF0E]?[ \xA0\\t,-]*") + (k1("9") + "#?|[- ]+") + (k1("6") + "#|[ \xA0\\t]*(?:,{2}|;)[:\\.\uFF0E]?[ \xA0\\t,-]*") + (k1("15") + "#?|[ \xA0\\t]*(?:,)+[:\\.\uFF0E]?[ \xA0\\t,-]*") + (k1("9") + "#?")
            }
            var bn = new RegExp("(?:" + fn() + ")$","i")
              , xa = new RegExp("^[0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]{2}$|^[+\uFF0B]*(?:[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E*]*[0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]){3,}[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E*A-Za-z0-9\uFF10-\uFF19\u0660-\u0669\u06F0-\u06F9]*(?:" + fn() + ")?$","i")
              , wa = /(\$\d)/
              , ka = /^\(?\$1\)?$/;
            function vn(d) {
                return 2 > d.length ? !1 : Le(xa, d)
            }
            function $n(d) {
                return Le(va, d) ? pi(d, pa) : pi(d, Eo)
            }
            function yn(d) {
                var n = $n(d.toString());
                Q(d),
            ...
            function Ea() {
                return Object.keys(gi).filter(function(d) {
                    return isNaN(d)
                })
            }
            function Ca() {
            ...
            function Aa() {
                var d = Object.keys(ct);
                return [...Ca(), ...d.map(function(n) {
                    return parseInt(n, 10)
                })]
            }
            function pi(d, n) {
                for (var l = new Z, p, u = d.length, b = 0; b < u; ++b)
                    p = d.charAt(b),
                    p = n[p.toUpperCase()],
                    p != null && l.g(p);
                return l.toString()
            ...
            function xn(d) {
                return d.length == 0 || ka.test(d)
            }
            function E1(d) {
                return d != null && isNaN(d) && d.toUpperCase()in gi
            }
            ed.prototype.format = function(d, n) {
                if (E(d, 2) == 0 && W(d, 5)) {
                    var l = z(d, 5);
                    if (0 < l.length)
                        return l
            ...
            function Ma(d, n) {
                ...
                if (!(p in ct))
                    return u;
                if (p == 1) {
                    if (n != null && ct[1].includes(n.toUpperCase()))
                ...
                var b = Qe(l, n)
                  , y = z(b, 11);
                return n = "",
                W(b, 17) ? n = z(b, 17) : Le(ua, y) && (n = y),
                l = C1(l, p, St(p)),
                u = wn(u, l, 1),
                d = En(d, l, 1),
                0 < n.length ? n + " " + p + " " + u + d : Co(p, 1, u, d)
            }
            function Dt(d) {
                if (!W(d, 2))
                    return "";
                var n = "" + E(d, 2);
                return W(d, 4) && E(d, 4) && 0 < z(d, 8) ? Array(z(d, 8) + 1).join("0") + n : n
            }
            function Co(d, n, l, p) {
                switch (n) {
                case 0:
            ...
            function wn(d, n, l) {
                n = _(n, 20).length == 0 || l == 2 ? _(n, 19) : _(n, 20);
                e: {
                    for (var p, u = n.length, b = 0; b < u; ++b) {
                        p = n[b];
                        var y = at(p, 3);
                ...
                z(u, 5),
                u = z(u, 4),
                d = l == 2 && u != null && 0 < u.length ? d.replace(p, n.replace(wa, u)) : d.replace(p, n),
            ...
            function En(d, n, l) {
                return W(d, 3) && E(d, 3).length != 0 ? l == 3 ? ";ext=" + E(d, 3) : W(n, 13) ? E(n, 13) + z(d, 3) : " ext. " + z(d, 3) : ""
            }
            function Cn(d, n) {
                switch (n) {
                case 4:
            ...
            function Ao(d, n) {
                return $e(d, E(n, 1)) ? $e(d, E(n, 5)) ? 4 : $e(d, E(n, 4)) ? 3 : $e(d, E(n, 6)) ? 5 : $e(d, E(n, 8)) ? 6 : $e(d, E(n, 7)) ? 7 : $e(d, E(n, 21)) ? 8 : $e(d, E(n, 25)) ? 9 : $e(d, E(n, 28)) ? 10 : $e(d, E(n, 2)) ? E(n, 18) || $e(d, E(n, 3)) ? 2 : 0 : !E(n, 18) && $e(d, E(n, 3)) ? 1 : -1 : -1
            }
            function Qe(d, n) {
                if (n == null)
                    return null;
            ...
            function $e(d, n) {
                var l = d.length;
                return 0 < at(n, 9) && _(n, 9).indexOf(l) == -1 ? !1 : Le(z(n, 2), d)
            }
            function An(d) {
                var n = X
                  , l = dd(n, d)
                  , p = z(d, 1)
                  , u = C1(n, p, l);
                return u == null || l != "001" && p != id(n, l) ? u = !1 : (d = Dt(d),
                u = Ao(d, u) != -1),
                u
            }
            function dd(d, n) {
                ...
                l == null)
                    ...
                    e: {
                        n = Dt(n);
                        for (var p, u = l.length, b = 0; b < u; b++) {
                            p = l[b];
                            var y = Qe(d, p);
                            if (W(y, 23)) {
            ...
            function Mo(d, n, l, p) {
                var u = Cn(l, p)
                  , b = at(u, 9) == 0 ? _(E(l, 1), 9) : _(u, 9);
                return u = _(u, 10),
                b[0] == -1 ? 5 : (n = n.length,
                -1 < u.indexOf(n) ? 4 : (l = b[0],
                l == n ? 0 : l > n ? 2 : b[b.length - 1] < n ? 3 : -1 < b.indexOf(n, 1) ? 0 : 5))
            }
            function Dn(d) {
                var n = X
                  , l = Dt(d);
                return d = z(d, 1),
                d in ct ? (d = C1(n, d, St(d)),
                Mo(n, l, d, -1)) : 1
            }
            function Sn(d, n) {
                if (d = d.toString(),
                d.length == 0 || d.charAt(0) == "0")
                    return 0;
                for (var l, p = d.length, u = 1; 3 >= u && u <= p; ++u)
                    if (l = parseInt(d.substring(0, u), 10),
                    l in ct)
                        return n.g(d.substring(u)),
                        l;
                return 0
            }
            function Tn(d, n, l, p, u) {
                if (n.length == 0)
                    return 0;
                n = new Z(n);
                var b;
                ...
                if (y.length == 0)
                    ...
                    b.search(y) == 0) {
                        ...
                        var M = b.substring(y).match(hn);
                        M && M[1] != null && 0 < M[1].length && pi(M[1], Eo) == "0" ? b = !1 : (Q(n),
                        n.g(b.substring(y)),
                        b = !0)
                    } else
                        b = !1;
                ...
                zn(y, l, null),
                y = y.toString(),
                !Le(M, n.toString()) && Le(M, y) || Mo(d, n.toString(), l, -1) == 3)) ? (p.g(y),
                ae(u, 1, b),
                b) : (ae(u, 1, 0),
                0)
            }
            function zn(d, n, l) {
                var p = d.toString()
                  , u = p.length
                  , b = E(n, 15);
                if (u != 0 && b != null && b.length != 0) {
                    var y = new RegExp("^(?:" + b + ")");
                    if (u = y.exec(p)) {
                        b = new RegExp(z(E(n, 1), 2));
                        var M = Le(b, p)
                          , N = u.length - 1;
                        n = E(n, 16),
                        n == null || n.length == 0 || u[N] == null || u[N].length == 0 ? (!M || Le(b, p.substring(u[0].length))) && (l != null && 0 < N && u[N] != null && l.g(u[1]),
                        d.set(p.substring(u[0].length))) : (p = p.replace(y, n),
                        (!M || Le(b, p)) && (l != null && 0 < N && l.g(u[1]),
                        d.set(p)))
                    }
                }
            }
            function Do(d, n, l) {
                ...
                u >= n.length)
                    ...
                    var b = n.indexOf(";", u);
                    u = b !== -1 ? n.substring(u, b) : n.substring(u)
                }
                var y = u;
                if (y == null ? b = !0 : y.length === 0 ? b = !1 : (b = $a.exec(y),
                y = ya.exec(y),
                b = b !== null || y !== null),
                !b || (u != null ? (u.charAt(0) === "+" && p.g(u),
                u = n.indexOf("tel:"),
                p.g(n.substring(0 <= u ? u + 4 : 0, n.indexOf(";phone-context=")))) : (u = p.g,
                n = n != null ? n : "",
                b = n.search(ha),
                0 <= b ? (n = n.substring(b),
                n = n.replace(ba, ""),
                b = n.search(fa),
                0 <= b && (n = n.substring(0, b))) : n = "",
                u.call(p, n)),
                n = p.toString(),
                u = n.indexOf(";isub="),
                0 < u && (Q(p),
                ...
                !vn(p.toString())))
                    throw Error("The string supplied did not seem to be a phone number");
                if (n = p.toString(),
                !(E1(l) || n != null && 0 < n.length && td.test(n)))
                    throw Error("Invalid country calling code");
                n = new lt;
                e: {
                    if (u = p.toString(),
                    b = u.search(bn),
                    0 <= b && vn(u.substring(0, b))) {
                        y = u.match(bn);
                ...
                try {
                    ...
                    if (te.message == "Invalid country calling code" && td.test(M)) {
                        if (M = M.replace(td, ""),
                        y = Tn(d, M, b, u, n),
                        y == 0)
                            throw te
                ...
                l != null && (y = z(b, 10),
                ae(n, 1, y))),
                2 > u.h.length || (b != null && (l = new Z(u.toString()),
                zn(l, b, new Z),
                d = Mo(d, l.toString(), b, -1),
                d != 2 && d != 4 && d != 5 && (u = l)),
                d = u.toString(),
                l = d.length,
                2 > l))
                ...
                return ae(n, 2, parseInt(d, 10)),
                n
            }
            ed.prototype.ia = function(d) {
                var n = Qe(this, dd(this, d));
                return n == null ? !0 : (d = Dt(d),
                !$e(d, E(n, 24)))
            }
            ;
            function Le(d, n) {
                return !!((d = n.match(new RegExp("^(?:" + (typeof d == "string" ? d : d.source) + ")$","i"))) && d[0].length == n.length)
            }
            function Da(d) {
                this.ja = RegExp("\u2008"),
                this.ka = "",
                ...
                this.j = [],
                this.la = d,
                this.xa = this.l = So(this, this.la)
            }
            var Ln = new st;
            ae(Ln, 11, "NA");
            var Sa = RegExp("^[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]*\\$1[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]*(\\$\\d[-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E]*)*$")
              , In = /[- ]/;
            function So(d, n) {
                return n = E1(n) ? id(d.pa, n) : 0,
                d = Qe(d.pa, St(n)),
                d != null ? d : Ln
            }
            function Nn(d) {
                for (var n = d.j.length, l = 0; l < n; ++l) {
                    var p = d.j[l]
                      , u = z(p, 1);
                    if (d.da == u)
                        return !1;
                    ...
                    var N = b;
                    y = z(y, 2);
                    var te = "999999999999999".match(M)[0];
                    if (te.length < N.g.h.length ? N = "" : (N = te.replace(new RegExp(M,"g"), y),
            ...
            function Bn(d, n) {
                for (var l = [], p = n.length - 3, u = d.j.length, b = 0; b < u; ++b) {
                    var y = d.j[b];
                    at(y, 3) == 0 ? l.push(d.j[b]) : (y = E(y, 3, Math.min(p, at(y, 3) - 1)),
                    n.search(y) == 0 && l.push(d.j[b]))
                }
                d.j = l
            }
            function Ta(d, n) {
                d.s.g(n);
                var l = n;
                if (hn.test(l) || d.s.h.length == 1 && ma.test(l) ? (n == "+" ? (l = n,
                d.ba.g(n)) : (l = Eo[n],
                d.ba.g(l),
                d.g.g(l)),
                n = l) : (d.u = !1,
                ...
                !d.u) {
                    if (!d.na) {
                        if (Yn(d)) {
                            if (Pn(d))
                                return Fn(d)
                        } else if (0 < d.o.length && (n = d.g.toString(),
                        Q(d.g),
                        d.g.g(d.o),
                        d.g.g(n),
                        n = d.h.toString(),
                ...
                case 3:
                    if (Yn(d))
                        ...
                        To(d);
                default:
                    return d.ea ? (Pn(d) && (d.ea = !1),
                    d.h.toString() + d.g.toString()) : 0 < d.j.length ? (n = Vn(d, n),
                    l = Rn(d),
                    0 < l.length ? l : (Bn(d, d.g.toString()),
                    Nn(d) ? On(d) : d.u ? ui(d, n) : d.s.toString())) : To(d)
                }
            }
            function Fn(d) {
                return d.u = !0,
            ...
            function Rn(d) {
                for (var n = d.g.toString(), l = d.j.length, p = 0; p < l; ++p) {
                    var u = d.j[p]
                      , b = z(u, 1);
                    if (new RegExp("^(?:" + b + ")$").test(n) && (d.ga = In.test(E(u, 4)),
                    u = n.replace(new RegExp(b,"g"), E(u, 2)),
                    u = ui(d, u),
                    pi(u, ga) == d.ba))
                        return u
                }
            ...
            function ui(d, n) {
                var l = d.h.h.length;
                return d.ga && 0 < l && d.h.toString().charAt(l - 1) != " " ? d.h + " " + n : d.h + n
            }
            function To(d) {
                var n = d.g.toString();
                if (3 <= n.length) {
                    for (var l = d.ca && d.o.length == 0 && 0 < at(d.l, 20) ? _(d.l, 20) : _(d.l, 19), p = l.length, u = 0; u < p; ++u) {
                        var b = l[u];
                        0 < d.o.length && xn(z(b, 4)) && !E(b, 6) && !W(b, 5) || (d.o.length != 0 || d.ca || xn(z(b, 4)) || E(b, 6)) && Sa.test(z(b, 2)) && d.j.push(b)
                    }
                    return Bn(d, n),
                    n = Rn(d),
                    0 < n.length ? n : Nn(d) ? On(d) : d.s.toString()
                }
                return ui(d, n)
            }
            function On(d) {
                ...
                if (0 < l) {
                    for (var p = "", u = 0; u < l; u++)
                        p = Vn(d, n.charAt(u));
                    return d.u ? ui(d, p) : d.s.toString()
                }
                return d.h.toString()
            }
            function Hn(d) {
                ...
                return p ? (l = 1,
                d.h.g("1").g(" "),
                d.ca = !0) : W(d.l, 15) && (p = new RegExp("^(?:" + E(d.l, 15) + ")"),
                p = n.match(p),
            ...
            function Pn(d) {
                ...
                d.g.g(n.toString()),
                n = St(l),
                n == "001" ? d.l = Qe(d.pa, "" + l) : n != d.la && (d.l = So(d, n)),
                d.h.g("" + l).g(" "),
                d.o = "",
                !0)
            }
            function Vn(d, n) {
                ...
                if (0 <= l.substring(d.aa).search(d.ja)) {
                    var p = l.search(d.ja);
                    return n = l.replace(d.ja, n),
                    Q(d.$),
                    d.$.g(n),
                    d.aa = p,
                    n.substring(0, d.aa + 1)
                }
            ...
            function La(d, n) {
                var l = Bo
                  , p = zo(z(d, 1));
                return n == null || !p.includes(n) || (n = Lo(l, n),
                !n) || (d = Io(d),
                l = E(n, 1),
                !No(d, l)) ? !1 : (n = E(n, 29),
                No(d, n))
            ...
            function No(d, n) {
                return 0 < _(n, 9).length && !_(n, 9).includes(d.length) ? !1 : Le(z(n, 2), d.toString())
            }
            var X = ed.oa()
              , Bo = jn.oa();
            function Na(d) {
            ...
            var od = ["PhoneNumber$$module$src$index"]
              , Ge = s;
            od[0]in Ge || typeof Ge.execScript == "undefined" || Ge.execScript("var " + od[0]);
            for (var Qt; od.length && (Qt = od.shift()); )
                od.length || T === void 0 ? Ge[Qt] && Ge[Qt] !== Object.prototype[Qt] ? Ge = Ge[Qt] : Ge = Ge[Qt] = {} : Ge[Qt] = T;
            ...
            function Wn(d, n) {
                var l = n == null ? void 0 : n.regionCode;
                if (typeof d == "string")
                    var p = !1;
                else
                    try {
                ...
                if (!p && typeof n != "object" && typeof n != "undefined")
                    throw Error(`Invalid options, expected object, got ${typeof n}. This may be because of not yet upgraded code.`);
                if (!p && l != null && typeof l != "string")
                    throw Error(`Invalid region code, expected a string, got ${typeof l} ${l}`);
                if (n = null,
                p ? (n = d,
                l = dd(X, n),
                d = X.format(n, 2)) : (d = d.trim(),
                l && d.charAt(0) === "+" && (l = null),
                l && d.charAt(0) !== "+" && d.slice(0, 2) !== "00" || ({v: l=null, parsed: n} = Ra(d, l))),
                !p) {
                    if (l) {
                        var u = Oo(l);
                        if (u === 0)
                            return Object.assign({}, Ro, l ? {
                                regionCode: l
                            } : {})
                    } else
                        return Ro;
            ...
            function hi(d, n) {
                ...
                d = Object.defineProperties(Object.create(null), {
                    ...
                    shortValid: {
                        ...
                        get: Je( () => {
                            var M = p
                              , N = zo(z(M, 1))
                              , te = Ia(M, N);
                            return 1 < N.length && te != null ? !0 : La(M, te)
                        }
                        )
                    },
                    shortPossible: {
                    ...
                    typeIsMobile: {
                        configurable: !1,
                        enumerable: !0,
                        value: n === "mobile" || n === "fixed-line-or-mobile"
                    },
                    typeIsFixedLine: {
                        configurable: !1,
                        enumerable: !0,
                        value: n === "fixed-line" || n === "fixed-line-or-mobile"
                    },
                    ...
                    countryCode: {
                        ...
                        get: Je( () => {
                            let M;
                            return (M = u) != null ? M : E1(l) ? id(X, l) : 0
                        }
                        )
                    }
                }),
            ...
            T.parse = hi;
            function Oo(d) {
                return E1(d) ? id(X, d) : 0
            }
            T.getCountryCodeForRegionCode = Oo,
            T.getRegionCodeForCountryCode = function(d) {
                return St(d)
            }
            ,
            T.findNumbers = function(d, n) {
                var l = n == null ? void 0 : n.defaultRegionCode, p, u = (p = n == null ? void 0 : n.leniency) != null ? p : "valid", b;
                n = (b = n == null ? void 0 : n.maxTries) != null ? b : Number.MAX_SAFE_INTEGER,
                b = /([0-9]+(?: [0-9]+)*)/g,
                p = [];
                for (let te = 0; te < n; ++te) {
                    ...
                    0 < Tt && d.charAt(Tt - 1) === "+" && --Tt;
                    var M = d.slice(Tt, y)
                      , N = hi(M, {
                        regionCode: l
                    });
                    (N.valid || u === "possible" && N.possible) && p.push({
                        text: M,
                        phoneNumber: N,
                        start: Tt,
                        end: y
            ...
            function qn(d) {
                var n = {};
                return d.filter(l => n.hasOwnProperty(l) ? !1 : (n[l] = 1,
                !0))
            }
            T.getSupportedRegionCodes = function() {
                return qn(Ea())
            }
            ,
            T.getSupportedCallingCodes = function() {
                return qn(Aa())
            }
            ,
            T.getExample = function(d, n) {
                var l;
                return n ? l = kn(d, Ba(n)) : l = kn(d, 0),
                hi(l, d)
            }
            ,
            T.getAsYouType = function(d) {
                return new ee(d)
            }
            ,
            T.getNumberFrom = function(d, n) {
                try {
                    e: {
                        if (mi) {
                            var l = mi.get(d);
                        ...
                        let u;
                        p = Wn(d == null || (u = d.number) == null ? void 0 : u.international).ra
                    }
                    return {
                        valid: !0,
                        number: Ma(p, n)
            ...
            ,
            T.prototype.toJSON = T.prototype.toJSON,
            T.prototype.ia = function() {
                return this.g.canBeInternationallyDialled
            }
            ,
            T.prototype.canBeInternationallyDialled = T.prototype.ia,
            T.prototype.Ba = function() {
                return this.g.valid
            }
            ,
            T.prototype.isValid = T.prototype.Ba,
            T.prototype.Aa = function() {
                return this.g.possible
            }
            ,
            T.prototype.isPossible = T.prototype.Aa,
            T.prototype.getType = function() {
                return this.g.type
            }
            ,
            T.prototype.getType = T.prototype.getType,
            T.prototype.za = function() {
                return this.g.type === "mobile" || this.g.type === "fixed-line-or-mobile"
            }
            ,
            T.prototype.isMobile = T.prototype.za,
            T.prototype.ya = function() {
                return this.g.type === "fixed-line" || this.g.type === "fixed-line-or-mobile"
            }
            ,
            T.prototype.isFixedLine = T.prototype.ya,
            T.prototype.ua = function(d) {
                return this.g.number[d == null ? "e164" : d]
            }
            ,
            T.prototype.getNumber = T.prototype.ua,
            T.prototype.wa = function() {
                return this.g.regionCode
            }
            ,
            T.prototype.getRegionCode = T.prototype.wa,
            T.prototype.ha = function() {
                return Oo(this.g.regionCode)
            }
            ,
            T.prototype.getCountryCode = T.prototype.ha;
            function ee(d) {
                this.l = d,
                this.j = new Da(d),
                this.g = this.h = ""
            }
            ee.prototype.sa = function(d) {
                this.h += d;
                var n = this.j;
                return n.ka = Ta(n, d),
                this.g = n.ka
            ...
            ,
            ee.prototype.addChar = ee.prototype.sa,
            ee.prototype.Ca = function() {
                return this.g
            }
            ,
            ee.prototype.number = ee.prototype.Ca,
            ee.prototype.Ea = function() {
                return this.h === "" ? this.g : this.reset(this.h.slice(0, this.h.length - 1))
            }
            ,
            ee.prototype.removeChar = ee.prototype.Ea,
            ee.prototype.reset = function(d) {
                var n = this.j;
                if (n.ka = "",
                Q(n.s),
                Q(n.ba),
                ...
                n.j = [],
                n.ga = !1,
                n.l != n.xa && (n.l = So(n, n.la)),
                this.g = this.h = "",
                d) {
                    n = 0;
                    for (var l = d.length; n < l; ++n)
                        this.sa(d.charAt(n))
                }
                return this.g
            }
            ...
            ,
            ee.prototype.getPhoneNumber = ee.prototype.va
        }
        ).call(r.exports || typeof globalThis != "undefined" && globalThis || typeof no != "undefined" && no || typeof window != "undefined" && window || typeof self != "undefined" && self || X2)
    }
    )(oo)),
    oo.exports
}
var es = io.exports, Dr;
function ts() {
    return Dr || (Dr = 1,
    (function(r) {
        let s = "PhoneNumber$$module$src$index";
        r.exports = _2()[s] || (typeof globalThis != "undefined" && globalThis || typeof no != "undefined" && no || typeof window != "undefined" && window || typeof self != "undefined" && self || es)[s],
        Object.defineProperty(r.exports, "__esModule", {
            value: !0
        }),
        r.exports.parsePhoneNumber = (...e) => {
            try {
                return r.exports.parse(...e)
            } catch (t) {
                return {
                    valid: !1,
                    possible: !1,
        ...
        ,
        r.exports.getCountryCodeForRegionCode = r.exports.getCountryCodeForRegionCode,
        r.exports.getRegionCodeForCountryCode = r.exports.getRegionCodeForCountryCode,
        r.exports.getSupportedCallingCodes = r.exports.getSupportedCallingCodes,
        r.exports.getSupportedRegionCodes = r.exports.getSupportedRegionCodes,
        r.exports.getExample = r.exports.getExample,
        r.exports.getAsYouType = r.exports.getAsYouType,
        r.exports.getNumberFrom = r.exports.getNumberFrom,
        r.exports.findNumbers = r.exports.findNumbers
    }
    )(io)),
    io.exports
}
...
var rs = {
        ...
        this.searchForCountry = e => {
            for (let t = 0; t < this.countries.length; t++)
                if (this.countries[t].name.toLowerCase().startsWith(e)) {
                    let i = this.shadowRoot.querySelector(`button[data-country="${this.countries[t].code}"]`);
                    i && o(this, a1).focusElement(i);
                    break
                }
        }
        ;
    ...
    get countries() {
        ...
        return this.topCountries.forEach(t => {
            let i = zd.find(a => a.code === t.toUpperCase());
            i && e.push(i)
        }
        ),
        e.concat(zd)
    ...
    render() {
        return Maquette.h("div", {
            ...
            on: {
                ...
                ,
                keydown: e => {
                    /^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(e.key) && (o(this, Y1) && clearTimeout(o(this, Y1)),
                    $(this, P1, o(this, P1) + e.key.toLowerCase()),
                    this.searchForCountry(o(this, P1)),
                    $(this, Y1, setTimeout( () => {
                        $(this, P1, "")
                    }
                    , 1e3)))
...
a1 = new WeakMap,
r1.style = zr,
m([Query(".phone-dropdown")], r1.prototype, "phoneDropdownElement", 2),
m([Property({
    type: "object",
    attribute: "top-countries",
    converter: rs
})], r1.prototype, "topCountries", 2),
r1 = m([CustomElementConfig({
    tagName: "pggm-phone-dropdown"
})], r1);
customElements.whenDefined("pggm-input-phone").then( () => {
    customElements.get("pggm-input-phone").parsePhoneNumber = jt
}
);
var Id, ie, ve, s1, V1, j1, l1, Nd, Bd, B, dn, on, Lr, Ir, Ye, nn, Nr, Fd, Rd, Od, Ld = class extends Vt {
    constructor(e) {
        super(e);
        g(this, B);
        g(this, Id, !1);
        ...
        g(this, Rd, e => {
            ...
            let t = jt(this.inputElement.value);
            if (t.possible === !1) {
                v(this, B, Ye).call(this);
                return
            }
        ...
        g(this, Od, e => {
            ...
            if (e.ctrlKey || e.metaKey)
                return;
            if (e.key === "ArrowDown") {
                v(this, B, nn).call(this);
                return
            }
            if (e.key === "ArrowUp") {
                v(this, B, Nr).call(this);
                return
            }
    ...
    set required(e) {
        o(this, j1) !== e && $(this, j1, typeof e == "string"),
        v(this, B, Ye).call(this)
    }
    get disabled() {
        return o(this, Id)
    ...
    set topCountries(e) {
        var t;
        $(this, Nd, e),
        (t = o(this, ie)) == null || t.setAttribute("top-countries", e)
    }
    get initialCountry() {
        return o(this, s1)
    }
    set initialCountry(e) {
        o(this, s1) !== e && $(this, s1, e),
        (!this.value || this.value === "") && (this.selectedCountry = e)
    }
    get selectedCountry() {
        return o(this, l1) || o(this, s1) || "NL"
    }
    set selectedCountry(e) {
        this.selectedCountry !== e && ($(this, l1, e),
        v(this, B, on).call(this),
        o(this, ve) || v(this, B, dn).call(this),
        o(this, ve).setAttribute("class", "flag flag-" + this.selectedCountry.toLowerCase()),
        o(this, ve).title = zd.find(t => t.code === this.selectedCountry).name,
    ...
    set phoneNumberType(e) {
        ...
        o(this, V1) !== e && ($(this, V1, e),
        v(this, B, on).call(this),
        v(this, B, Ye).call(this))
    }
    get value() {
        var t;
        return ((t = jt(this.inputElement.value, {
            regionCode: this.selectedCountry.toUpperCase()
    ...
    set value(e) {
        ...
        let i = ((c = t.number) == null ? void 0 : c.e164) || e;
        this.internals.setFormValue(i),
        v(this, B, Ye).call(this)
    }
    get countryLabel() {
        return o(this, Bd) || "Select your country"
    }
    set countryLabel(e) {
        $(this, Bd, e),
        o(this, ve) && (o(this, ve).title = e || "")
    }
    connected() {
        super.connected(),
        o(this, ie) && this.customInput.shadowRoot.appendChild(o(this, ie)),
        o(this, ve) || v(this, B, dn).call(this),
        v(this, B, Lr).call(this)
    }
    disconnected() {
        super.disconnected(),
        o(this, ie) && o(this, ie).remove(),
        v(this, B, Ir).call(this)
    }
}
;
Id = new WeakMap,
...
dn = function() {
    ...
    $(this, ve, document.createElement("button")),
    O(this.customInput.shadowRoot, Tr, "pggm-input-phone-flag"),
    o(this, ve).setAttribute("class", "flag flag-" + this.selectedCountry.toLowerCase()),
    o(this, ve).title = this.countryLabel ? this.countryLabel : "",
    this.customInput.shadowRoot.prepend(o(this, ve), this.inputElement),
    o(this, ve).addEventListener("click", () => {
        v(this, B, nn).call(this)
    }
    )
}
...
on = function() {
    ...
    !(!o(this, l1) || o(this, l1).length < 2) && (this.inputElement.placeholder = Sr(this.selectedCountry, e).number.national)
}
,
Lr = function() {
    this.inputElement.addEventListener("keydown", o(this, Od)),
    this.inputElement.addEventListener("blur", o(this, Fd)),
    this.inputElement.addEventListener("change", o(this, Rd))
}
,
Ir = function() {
    this.inputElement.removeEventListener("keydown", o(this, Od)),
    this.inputElement.removeEventListener("blur", o(this, Fd)),
    this.inputElement.removeEventListener("change", o(this, Rd))
}
,
Ye = function() {
    let e = () => {
...
var K, Hd, ro, ao, Fr, W1, Yd, dt = class extends CustomElement {
    constructor() {
        ...
        g(this, W1, e => {
            e.composedPath().map(i => i.nodeName).includes("PGGM-CALENDAR") || this.hide()
        }
        );
        g(this, Yd, e => {
        ...
        $(this, K, Maquette.dom.create(Maquette.h("pggm-calendar", null)).domNode),
        o(this, K).addEventListener("calendarDateChange", o(this, ro)),
        this.appendChild(o(this, K))
    }
    connectedCallback() {
        super.connectedCallback(),
        O(this.getRootNode(), Br, dt.TAG_NAME)
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        window.removeEventListener("click", o(this, W1))
    }
    show(e) {
        if ($(this, Hd, e),
        this.dateFormat.period) {
            if (o(this, K).setAttribute("type", "period"),
            typeof this.dateFormat.value == "string") {
                ...
                h && f && (o(this, K).value = [a, c])
            }
            this.setAttribute("open", "")
        } else
            o(this, K).setAttribute("type", "date"),
            customElements.get("pggm-calendar").parseDate(this.dateFormat.value) && (o(this, K).value = this.dateFormat.value),
            this.setAttribute("open", "");
        let i = customElements.get("pggm-calendar").parseDate(this.dateFormat.value);
        o(this, K).displayDate = i || new Date,
        this.dateFormat.lang ? o(this, K).setAttribute("lang", this.dateFormat.lang) : this.removeAttribute("lang"),
        o(this, K).minDate = customElements.get("pggm-calendar").parseDate(this.dateFormat.min),
        o(this, K).minDate && o(this, K).minDate > o(this, K).displayDate && (o(this, K).displayDate = o(this, K).minDate),
        o(this, K).maxDate = customElements.get("pggm-calendar").parseDate(this.dateFormat.max),
        v(this, ao, Fr).call(this),
        o(this, K).focus({
            preventScroll: !0
        }),
        window.addEventListener("keydown", o(this, Yd)),
        window.addEventListener("click", o(this, W1))
    }
    hide() {
        var e;
        this.removeAttribute("open"),
        (e = o(this, Hd)) == null || e.focus({
            preventScroll: !0
        }),
        window.removeEventListener("click", o(this, W1)),
        window.removeEventListener("keydown", o(this, Yd))
    }
}
;
K = new WeakMap,
...
Fr = function() {
    requestAnimationFrame( () => {
        Yt(this.dateFormat.inputElement, this, {
...
var Se, Wt, yt, xt, qt, q1, so, ke, Or, K1, Vd, jd, Wd, U1, lo, qd, c1, Hr, Pd = class extends Vt {
    constructor(e) {
        ...
        g(this, qt);
        g(this, q1);
        g(this, so, ["aria-invalid", "aria-label"]);
        g(this, K1, !1);
        g(this, Vd, !1);
        g(this, jd, null);
        g(this, Wd, null);
        ...
        g(this, lo, e => {
            let t = this.valueFromdisplayFormat(this.inputEndDateElement.value)
              , i = this.valueFromdisplayFormat(this.inputElement.value)
              , a = [i, t].map(c => customElements.get("pggm-calendar").parseDate(c));
            if (a.some(c => !c)) {
                this.value = `${a[0] ? i : this.inputElement.value},${a[1] ? t : this.inputEndDateElement.value}`;
                return
            }
        ...
        $(this, Se, document.createElement("button")),
        o(this, Se).setAttribute("aria-label", "Open date picker"),
        o(this, Se).type = "button",
        o(this, Se).classList.add("pggm-input-date-trigger", "focus"),
        o(this, Se).innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"  fill="currentColor">
        ...
        $(this, Wt, new dt),
        o(this, Wt).dateFormat = this,
        o(this, Se).addEventListener("click", t => {
            t.preventDefault(),
            t.stopPropagation(),
            o(this, Wt).show()
        }
        ),
        $(this, qt, o(this, Se).cloneNode(!0)),
        o(this, qt).classList.add("pggm-input-date-trigger--first"),
        o(this, qt).addEventListener("click", t => {
            t.preventDefault(),
            t.stopPropagation(),
            o(this, Wt).show(this.inputEndDateElement)
        }
        ),
        O(this.customInput.shadowRoot, Rr, "pggm-input-date-trigger"),
        this.customInput.shadowRoot.appendChild(o(this, Wt)),
        this.inputElement.type = "text",
        this.inputElement.addEventListener("change", o(this, qd)),
        this.inputEndDateElement.addEventListener("change", o(this, qd)),
        $(this, U1, "dd-mm-yyyy"),
        this.customInput.hasAttribute("value") ? $(this, yt, this.customInput.getAttribute("value")) : $(this, yt, ""),
        requestAnimationFrame( () => {
            this.customInput.shadowRoot.appendChild(o(this, Se)),
            this.value = o(this, yt)
        }
        ),
        v(this, ke, Or).call(this)
    }
    get period() {
        return o(this, xt)
    }
    set period(e) {
        o(this, xt) !== e && ($(this, xt, typeof e == "string"),
        o(this, xt) ? (this.customInput.shadowRoot.appendChild(this.inputEndDateElement),
        this.customInput.shadowRoot.insertBefore(o(this, qt), this.inputEndDateElement)) : (this.inputEndDateElement.remove(),
        o(this, qt).remove()))
    }
    get lang() {
    ...
    set required(e) {
        o(this, K1) !== e && $(this, K1, typeof e == "string"),
        v(this, ke, c1).call(this)
    }
    get disabled() {
        return o(this, Vd)
    ...
    valueTodisplayFormat(e) {
        if (!e)
            return "";
        let[t,i,a] = e.split("-");
        return !t || !i || !a ? "" : (this.format || "dd-mm-yyyy").replace("yyyy", t).replace("mm", i).replace("dd", a)
    }
    valueFromdisplayFormat(e) {
        let i = (this.format || "dd-mm-yyyy").split("-")
          , a = e.split("-");
        if (i.length !== 3 || a.length !== 3)
            return "";
        let c = a[i.indexOf("yyyy")]
          , h = a[i.indexOf("mm")]
          , f = a[i.indexOf("dd")]
          , w = h.padStart(2, "0")
          , k = f.padStart(2, "0");
    ...
    connected() {
        super.connected(),
        o(this, q1).observe(this.inputElement, {
            attributes: !0,
            attributeFilter: o(this, so)
        })
    }
    disconnected() {
        super.disconnected(),
        o(this, q1).disconnect()
    }
}
;
Se = new WeakMap,
...
ke = new WeakSet,
Or = function() {
    $(this, q1, new MutationObserver(e => {
        e.forEach(t => {
...
c1 = function() {
    ...
    let t = customElements.get("pggm-calendar").parseDate(this.min)
      , i = customElements.get("pggm-calendar").parseDate(this.max);
    if (this.min && e < t) {
        this.internals.setValidity({
            rangeUnderflow: !0
...
,
Pd.attributes = ["required", "format", "min", "max", "period", "lang", "period"];
var Te = class extends HTMLInputElement {
    connectedCallback() {
        O(this.getRootNode(), kr, Te.TAG_NAME)
    }
}
;
Te.observedAttributes = ["input-format"],
Te.TAG_NAME = "pggm-input",
Te = m([CustomElementConfig({
    tagName: Te.TAG_NAME,
    options: {
        extends: "input"
    }
...
var rn = class extends HTMLElement {
  ...
  , ls = r => {
    var t, i, a;
    let s = [...co[r].prototype.constructor.attributes, "value", "disabled", "readonly"]
      , e = (t = class extends rn {
        constructor() {
            super();
            g(this, i);
            g(this, a, !1);
      ...
      `, this.tagName),
        ...
        connectedCallback() {
            ...
            o(this, a) || ($(this, a, !0),
            o(this, i).init()),
            (f = o(this, i)) == null || f.connected()
        }
        disconnectedCallback() {
            var f;
            (f = o(this, i)) == null || f.disconnected()
        }
        attributeChangedCallback(f, w, k) {
            let x = f.replace(/-([a-z])/g, A => A[1].toUpperCase());
            o(this, i) && o(this, i)[x] !== k && (o(this, i)[x] = k)
        }
        reportValidity() {
            return this.internals.reportValidity()
        }
        ...
        get value() {
            return o(this, i).value
        }
        set value(f) {
            o(this, i).value ? o(this, i).value = f : this.setAttribute("value", f)
        }
    }
    ,
    i = new WeakMap,
...
;
for (let r in co)
    customElements.define(Te.TAG_NAME + "-" + r, ls(r));
var Yr, J4 = (Yr = go.find(r => r.formater === "iban")) == null ? void 0 : Yr.cls, Pr, X4 = (Pr = go.find(r => r.formater === "phone")) == null ? void 0 : Pr.cls, Vr, _4 = (Vr = go.find(r => r.formater === "date")) == null ? void 0 : Vr.cls;
var jr = `:host{display:-webkit-box;display:-ms-flexbox;display:flex}.inline-content-block{display:none;margin:16px 0;position:relative;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.inline-content-block:before{background:#9c9fa3;background:var(--Manatee,#9c9fa3);content:"";height:100%;left:-14px;position:absolute;width:2px}.inline-content-block--open{display:-webkit-box;display:-ms-flexbox;display:flex}
`;
var Pe, po, Wr, Kd, g1, Ud, Kt = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, po);
        g(this, Pe, null);
        ...
        g(this, g1, e => {
            let t = e.target.ariaDescribedByElements ? e.target.ariaDescribedByElements[0].localName : null
              , i = e.key
              , a = e.target;
            !e.defaultPrevented && a && ((i === "Escape" || i === "Esc") && (this.open = !1),
            (i === "Enter" || i === " ") && t && t !== "ppgm-inline-content-block" && (e.preventDefault(),
            this.open = !this.open))
        }
        );
        g(this, Ud, e => {
    ...
    set for(e) {
        var a;
        let t = e;
        if (typeof t == "string" && (t = v(this, po, Wr).call(this, t)),
        this.id || (this.id = `ICB${Math.random().toString(36).slice(-6)}`),
        o(this, Pe) === t)
            return;
        let i = o(this, Pe);
        i && this.removeEventHandlers(i),
        $(this, Pe, t),
        t && ((a = o(this, Pe)) == null || a.setAttribute("aria-describedby", this.id),
        o(this, Pe).setAttribute("tabindex", "0"),
        o(this, Pe) && this.addEventHandlers(o(this, Pe)))
    }
    addEventHandlers(e) {
        e.addEventListener("focus", o(this, Kd)),
        e.addEventListener("keydown", o(this, g1)),
        e.addEventListener("click", o(this, Ud))
    }
    removeEventHandlers(e) {
        e.removeEventListener("focus", o(this, Kd)),
        e.removeEventListener("keydown", o(this, g1)),
        e.removeEventListener("click", o(this, Ud))
    }
    connectedCallback() {
        super.connectedCallback(),
        requestAnimationFrame( () => {
            ...
            e && (this.for = e),
            this.addEventListener("keydown", o(this, g1))
        }
        )
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        this.removeEventListener("keydown", o(this, g1))
    }
    onAttributeChange(e, t, i) {
        e === "open" ? this.open = i !== null : e === "for" && (this.for = i)
    }
}
;
Pe = new WeakMap,
...
var Zd, it = class extends HTMLAnchorElement {
    ...
    connectedCallback() {
        O(this.getRootNode(), Kr, it.TAG_NAME),
        this.hasAttribute("standalone") && o(this, Zd).call(this)
    }
...
;
Zd = new WeakMap,
it.TAG_NAME = "pggm-link",
it.observedAttributes = ["standalone"],
it = m([CustomElementConfig({
    tagName: it.TAG_NAME,
    options: {
        extends: "a"
...
var Z1, Qd, oe = class extends CustomElement {
    constructor() {
        ...
        g(this, Z1, () => {
            let e = this.getRootNode();
            e == null || e.querySelectorAll(`${oe.TAG_NAME}[name="${this.name}"]`).forEach(t => {
        ...
        g(this, Qd, e => {
            if (e.key === " ")
                ...
                e.preventDefault();
                let t = this.getRootNode()
                  , i = Array.from(t.querySelectorAll(`${oe.TAG_NAME}[name="${this.name}"]:not([disabled])`))
                  , a = e.key === "ArrowDown" || e.key === "ArrowRight"
                  , h = (i.indexOf(this) + (a ? 1 : -1) + i.length) % i.length;
                i[h].focus(),
                this.checked = !1,
                i[h].checked = !0
            }
    ...
    connectedCallback() {
        ...
        this.tabIndex = this.disabled ? -1 : 0,
        this.internals.ariaDisabled = this.disabled ? "true" : "false",
        this.addEventListener("click", o(this, Z1)),
        this.addEventListener("keydown", o(this, Qd))
    }
    disconnectedCallback() {
        super.disconnectedCallback(),
        this.removeEventListener("click", o(this, Z1)),
        this.removeEventListener("keydown", o(this, Qd))
    }
}
;
Z1 = new WeakMap,
...
var Zr = `.pggm-radio-group,.pggm-radio-group__options{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;gap:var(--pggm-radio-group-row-gap)}:host([horizontal]) .pggm-radio-group__options{-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;gap:calc(var(--pggm-radio-group-row-gap)*2)}#GroupOptions ::slotted(:not(pggm-radio)){display:none;visibility:hidden}
`;
var uo, mo, Ve = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, uo, e => {
            let i = e.target.assignedNodes()
    ...
    updated(e, t, i) {
        e === "disabled" && o(this, mo).call(this, i)
    }
    render() {
        return Maquette.h("div", {
            classes: {
...
je = m([CustomElementConfig({
    tagName: je.TAG_NAME
})], je);
function an(r, s, e=3e3) {
    return G(this, null, function*() {
        return new Promise(t => {
            let a = 0
              , c = () => {
                let h = r.querySelector(s);
...
var bo = class extends CustomElement {
    constructor() {
        ...
        this.mutationCallback = e => {
            e.forEach(t => {
                var a;
                let i = t.target;
                t.target.nodeType === this.TEXT_NODE && (i = t.target.parentElement),
                i.getAttribute("slot") !== "title" && (i = i.closest('[slot="title"]')),
                i && ((a = this.tabElement) == null || a.updateTabPanel(this))
            }
            )
        }
        ;
        let e = this.templateFromString(`<style>${Jr}</style>
    ...
    set active(e) {
        ...
        e ? (t.tabPanels.forEach(a => {
            ...
            a.setAttribute(i, "false"),
            a.removeAttribute("active")),
            a.id && an(t.shadowRoot, `[aria-controls="${a.id}"]`).then(c => {
                c && (c.setAttribute(i, "false"),
        ...
        this.setAttribute(i, "true")) : (this.hidden = !0,
        this.removeAttribute("active"),
        this.setAttribute(i, "false")),
        an(t.shadowRoot, `[aria-controls="${this.id}"]`).then(a => {
            a.setAttribute(i, e ? "true" : "false"),
...
, p1, u1, We, Et, Jd, vo, $o, yo, xo, m1, Xd, wo, _d, ei, h1, ti, f1, di, ii, ko, Gd = class extends CustomElement {
    constructor() {
        super();
        g(this, p1);
        g(this, u1, !1);
        ...
        g(this, vo, () => {
            this.addEventListener("keydown", o(this, di)),
            window.addEventListener("hashchange", o(this, Jd)),
            window.addEventListener("resize", o(this, ei));
            let e = this.shadowRoot.querySelector(".tabs--tabstrip-button--prev")
              , t = this.shadowRoot.querySelector(".tabs--tabstrip-button--next");
            t && t.addEventListener("click", o(this, xo)),
            e && e.addEventListener("click", o(this, yo))
        }
        );
        g(this, $o, () => {
            this.removeEventListener("keydown", o(this, di)),
            window.removeEventListener("hashchange", o(this, Jd)),
            window.removeEventListener("resize", o(this, ei))
        }
        );
        g(this, yo, () => {
            let e = this.tabsProperties
              , t = o(this, We) + e.width;
            o(this, f1).call(this, t),
            o(this, Xd).call(this)
        }
        );
        g(this, xo, () => {
        ...
        g(this, m1, e => this.shadowRoot.querySelector(`[aria-controls="${e}"]`));
        g(this, Xd, () => {
            o(this, m1).call(this, this.tabPanels[this.selected].id).focus()
        }
        );
        g(this, wo, () => {
            o(this, f1).call(this, o(this, We))
        }
        );
        g(this, _d, () => {
            o(this, wo).call(this),
        ...
        g(this, ei, () => {
            o(this, p1) && window.clearTimeout(o(this, p1)),
            o(this, u1) ? $(this, p1, window.setTimeout( () => {
                $(this, u1, !1),
                o(this, _d).call(this)
            }
            , 200)) : ($(this, u1, !0),
            o(this, _d).call(this),
            $(this, p1, window.setTimeout( () => {
                $(this, u1, !1)
            }
            , 200)))
        }
        ...
        g(this, h1, () => {
            ...
            if (e && t) {
                t.hidden = !0,
                o(this, We) < 0 ? e.hidden = !1 : e.hidden = !0;
                let i = this.tabsProperties;
                if (i.totalWidth > i.width && o(this, We) > i.maxOffset)
                    t.hidden = !1;
                else {
                    t.hidden = !0;
                    let a = this.shadowRoot.querySelector("#TabStrip");
                    a.style.transform = `translateX(${i.maxOffset}px)`
                }
            }
        }
        );
        g(this, ti, (e, t) => {
            if (!e)
                return;
            let i = this.tabsProperties
              , c = -1 * (e.getBoundingClientRect().left - i.left - o(this, We));
            o(this, f1).call(this, c, t)
        }
        );
        g(this, f1, (e, t) => {
            let i = this.tabsProperties
              , a = e > 0 ? 0 : e;
            a < i.maxOffset && (a = i.maxOffset),
            $(this, We, Math.floor(a));
            ...
            c.style.transform = `translateX(${o(this, We)}px)`,
            o(this, h1).call(this)
        }
        );
        g(this, di, e => {
            ...
            case "ArrowLeft":
                ...
                Lt(o(this, Et), this.tabPanels[t].id, !0);
                break;
            case "ArrowRight":
                e.preventDefault(),
                t = this.selected + 1,
                Lt(o(this, Et), this.tabPanels[t % this.tabPanels.length].id, !0);
                break;
            case "End":
                e.preventDefault(),
        ...
        g(this, ii, e => {
            ...
            !t)
                return;
            let i = [...this.tabPanels].find(a => a.id === t.getAttribute("aria-controls"));
            i && Lt(o(this, Et), i.id, !0)
        }
        );
        g(this, ko, e => {
            let t = !1
              , i = this.currentHashValue
              , a = [...this.tabPanels].findIndex(h => e === h)
              , c = [...this.tabPanels].findIndex(h => h.hasAttribute("active"));
            return this.hashIsTab() && i !== e.id ? !1 : ((i === e.id || this.getAttribute("selected") === a.toString() || a === c || !this.hasAttribute("selected") && c === -1 && !this.hashIsTab() && a === 0) && (t = !0),
            t)
        }
        );
        this.hashIsTab = () => {
        ...
        ;
        let e = this.templateFromString(`<style>${Xr}</style>
    ...
    attributeChangedCallback(e, t, i) {
        e === "selected" && (this.selected = parseInt(i, 10))
    }
    setActiveTab(e, t=!1) {
        if (!e)
            return !1;
        let i = [...this.tabPanels].find(a => a.id === e);
        if (i && !i.active) {
            i.active = !0;
            let a = o(this, m1).call(this, e);
            return o(this, ti).call(this, a),
            t && a.focus(),
    ...
    addTabPanel(e) {
        ...
        let t = this.shadowRoot.querySelector("#TabStrip")
          , i = [...this.tabPanels].findIndex(h => e === h)
          , a = t.childNodes.length >= i + 1 ? t.childNodes[i + 1] : null
          , c = e.getTabPanelTitleElement();
        if (c.setAttribute("aria-controls", e.id),
        a ? t.insertBefore(c, a) : t.appendChild(c),
        c.addEventListener("click", o(this, ii), {
            passive: !0
        }),
        e.active = o(this, ko).call(this, e),
        e.active) {
            let h = this.currentHashValue
              , f = o(this, m1).call(this, h);
            o(this, ti).call(this, f, !1)
        }
        o(this, h1).call(this)
    }
    removeTabPanel(e) {
        ...
        if (!e)
            return;
        let t = o(this, m1).call(this, e.id);
        t.removeEventListener("click", o(this, ii)),
        (i = t == null ? void 0 : t.parentElement) == null || i.removeChild(t),
        o(this, h1).call(this)
    }
    updateTabPanel(e) {
...
var ot, Ut, v1, Ee, qe, $1, ia, sn, Q1, G1, J1, X1, oi, ni, b1 = class extends CustomElement {
    constructor() {
        ...
        g(this, G1, () => {
            $(this, Ut, !1),
            setTimeout( () => {
                !o(this, ot) && !o(this, v1) && !o(this, Ut) && this.hide()
            }
            , 1e3)
        }
        );
        ...
        g(this, oi, e => {
            e.preventDefault(),
            e.stopPropagation(),
            o(this, ot) ? requestAnimationFrame( () => {
                $(this, ot, !1),
                $(this, Ut, !1),
                $(this, v1, !0),
                this.open = !0
        ...
        this.show = () => G(this, null, function*() {
            o(this, qe) || $(this, qe, yield o(this, $1, sn)),
            o(this, qe).showPopover(),
        ...
        this.hide = () => G(this, null, function*() {
            $(this, v1, !1),
            o(this, qe) || $(this, qe, yield o(this, $1, sn)),
            o(this, qe).style.opacity = "0",
            o(this, qe).hidePopover(),
            this.open && (this.open = !1)
        });
        this.onTooltipCreate = e => {
            e.setAttribute("popover", ""),
            e.addEventListener("toggle", t => {
                t.newState === "closed" ? this.open = !1 : t.newState === "open" && (this.open = !0,
                o(this, ni).call(this))
            }
            )
        }
        ...
        this.render = () => Maquette.h("div", {
            class: "tooltip",
            afterCreate: this.onTooltipCreate
        }, Maquette.h("slot", null))
    }
    get open() {
    ...
    set open(e) {
        e ? (this.hasAttribute("open") || this.setAttribute("open", ""),
        this.show()) : (this.hasAttribute("open") && this.removeAttribute("open"),
        this.hide())
    }
    get for() {
        return o(this, Ee)
    ...
    set for(e) {
        var a, c, h;
        let t = e;
        if (typeof t == "string" && (t = v(this, $1, ia).call(this, t)),
        this.id || (this.id = `Tooltip${Math.random().toString(36).slice(-6)}`),
        o(this, Ee) === t)
            return;
        let i = o(this, Ee);
        i && ((a = o(this, Ee)) == null || a.removeAttribute("popovertarget"),
        i.removeEventListener("click", o(this, oi))),
        $(this, Ee, t),
        t && ((c = o(this, Ee)) == null || c.setAttribute("aria-describedby", this.id),
        (h = o(this, Ee)) == null || h.setAttribute("popovertarget", this.id),
        o(this, Ee) && this.addEventHandlers(o(this, Ee)))
    }
    addEventHandlers(e) {
        e.addEventListener("click", o(this, oi)),
        e.addEventListener("focus", o(this, Q1)),
        e.addEventListener("blur", o(this, G1)),
        e.addEventListener("mouseenter", o(this, J1)),
        e.addEventListener("mouseleave", o(this, X1))
    }
    connectedCallback() {
        super.connectedCallback(),
        requestAnimationFrame( () => {
            let e = this.getAttribute("for");
            e && (this.for = e),
            this.addEventListener("focus", o(this, Q1)),
            this.addEventListener("blur", o(this, G1)),
            this.addEventListener("mouseenter", o(this, J1)),
            this.addEventListener("mouseleave", o(this, X1)),
    ...
    disconnectedCallback() {
        super.disconnectedCallback(),
        this.removeEventListener("focus", o(this, Q1)),
        this.removeEventListener("blur", o(this, G1)),
        this.removeEventListener("mouseenter", o(this, J1)),
        this.removeEventListener("mouseleave", o(this, X1)),
...
sn = function() {
    return new Promise(e => {
        let t = () => {
            var a;
            let i = (a = this.shadowRoot) == null ? void 0 : a.querySelector(".tooltip");
            i && e(i),
            setTimeout(t, 30)
        }
        ;
...
ni = new WeakMap,
b1.style = da,
b1.observedAttributes = ["open", "for"],
b1 = m([CustomElementConfig({
    tagName: "pggm-tooltip"
})], b1);
var oa = `:host{background-color:transparent!important;border:0!important;-webkit-box-sizing:border-box!important;box-sizing:border-box!important;margin:0!important;max-width:300px!important;opacity:0!important;padding:0!important;position:absolute!important}:host([show]){opacity:1!important}.toggletip{line-height:24px;--toggletip-offset:var(--pggm-toggletip-offset,8px);background-color:var(--toggletip-background-color,var(--tooltip-background-color,var(--pggm-color-white)));border:1px solid var(--pggm-toggletip-border-color,var(--pggm-tooltip-border-color,var(--pggm-color-gray-50)));border-radius:var(--toggletip-border-radius,var(--tooltip-border-radius,var(--pggm-focus-border-radius)));-webkit-box-shadow:0 2px 4px 0 rgba(0,0,0,.2);box-shadow:0 2px 4px #0003;-webkit-box-shadow:var(--pggm-toggletip-box-shadow-offset-x,var(--pggm-tooltip-box-shadow-offset-x,0)) var(--pggm-toggletip-box-shadow-offset-y,var(--pggm-tooltip-box-shadow-offset-y,2px)) var(--pggm-toggletip-box-shadow-blur,var(--pggm-tooltip-box-shadow-blur,4px)) var(--pggm-toggletip-box-shadow-spread,var(--pggm-tooltip-box-shadow-spread,0)) var(--pggm-toggletip-box-shadow-color,var(--pggm-tooltip-box-shadow-color,rgba(0,0,0,.2)));box-shadow:var(--pggm-toggletip-box-shadow-offset-x,var(--pggm-tooltip-box-shadow-offset-x,0)) var(--pggm-toggletip-box-shadow-offset-y,var(--pggm-tooltip-box-shadow-offset-y,2px)) var(--pggm-toggletip-box-shadow-blur,var(--pggm-tooltip-box-shadow-blur,4px)) var(--pggm-toggletip-box-shadow-spread,var(--pggm-tooltip-box-shadow-spread,0)) var(--pggm-toggletip-box-shadow-color,var(--pggm-tooltip-box-shadow-color,rgba(0,0,0,.2)));color:var(--toggletip-color,var(--tooltip-color,var(--pggm-color-black)));padding:16px 16px 12px;padding:var(--pggm-toggletip-padding-block-start,var(--pggm-tooltip-padding-block-start,16px)) var(--pggm-toggletip-padding-inline-start,var(--pggm-tooltip-padding-inline-start,16px)) var(--pggm-toggletip-padding-block-end,var(--pggm-tooltip-padding-block-end,12px)) var(--pggm-toggletip-padding-inline-end,var(--pggm-tooltip-padding-inline-end,16px))}.toggletip ::slotted(*){margin:0;padding:0}
`;
var ri, x1, ze, ai, si, li, P, ln, w1, na, ra, aa, sa, y1, _1, cn, Ce = class extends CustomElement {
    constructor() {
        super(...arguments);
        g(this, P);
        g(this, ri, !1);
        ...
        g(this, li, e => {
            e.target === this && e.oldState === "open" && (requestAnimationFrame( () => {
                $(this, ri, !1),
                this.visible = !1
            }
            ),
        ...
        g(this, w1, parseInt(getComputedStyle(this).getPropertyValue("--toggletip-offset"), 10) ? parseInt(getComputedStyle(this).getPropertyValue("--toggletip-offset"), 10) : 8);
        this.hide = () => {
            this.visible = !1
        }
        ;
        ...
        this.render = () => Maquette.h("div", {
            ...
            classes: {
                toggletip: !0,
                "toggletip-above": this._position === "above",
                "toggletip-below": this._position === "below",
                "toggletip-before": this._position === "before",
                "toggletip-after": this._position === "after"
            }
        }, Maquette.h("div", {
            part: "content",
            class: "toggletip-content"
        }, Maquette.h("slot", null)))
    }
    get for() {
        return o(this, ze)
    ...
    set for(e) {
        if (typeof e == "string" && (e = v(this, P, cn).call(this, e)),
        this.id || (this.id = `Toggletip-${crypto.randomUUID()}`),
        o(this, ze) === e)
            return;
        let t = o(this, ze);
        t && (o(this, ze).removeAttribute("popovertarget"),
        t.removeEventListener("click", o(this, ai))),
        $(this, ze, e),
        e && (o(this, ze).setAttribute("aria-describedby", this.id),
        o(this, ze).setAttribute("tabindex", "0"),
        o(this, ze).setAttribute("popovertarget", this.id),
        this.addClickHandler(e))
    }
    connectedCallback() {
        this.setAttribute("popover", ""),
        this.setAttribute("role", "dialog"),
        this.addEventListener("beforetoggle", o(this, li)),
        window.addEventListener(Ce.POPOVER_SHOW_EVENT, o(this, si)),
        this.addEventListener("blur", o(this, _1))
    }
    disconnectedCallback() {
        this.removeEventListener("beforetoggle", o(this, li)),
        this.removeEventListener("blur", o(this, _1)),
        window.removeEventListener(Ce.POPOVER_SHOW_EVENT, o(this, si)),
        window.removeEventListener("scroll", this.hide)
    }
    static get observedAttributes() {
        return ["for", "position"]
    ...
    attributeChangedCallback(e, t, i) {
        if (e === "for") {
            let a = v(this, P, cn).call(this, i);
            if (!a)
                return;
            this.for = a
        } else
            e === "position" && (this._position = i)
    }
    get visible() {
        return o(this, x1)
    }
    set visible(e) {
        o(this, x1) !== e && ($(this, x1, e),
        o(this, x1) ? (this.dispatchEvent(new CustomEvent(Ce.POPOVER_SHOW_EVENT,{
            bubbles: !0
        })),
        this.showPopover(),
        v(this, P, y1).call(this, this._position).then(t => {
            this.style.top = `${t.top}px`,
            this.style.left = `${t.left}px`,
            v(this, P, y1).call(this, this._position).then(i => {
                this.style.top = `${i.top}px`,
                this.style.left = `${i.left}px`,
                this.style.zIndex = "1",
        ...
        ["top", "left", "z-index"].forEach(t => {
            this.style.removeProperty(t)
        }
        )))
    }
    addClickHandler(e) {
        e.addEventListener("click", o(this, ai)),
        e.addEventListener("blur", o(this, _1))
    }
}
;
ri = new WeakMap,
...
P = new WeakSet,
ln = function(e, t) {
    let i = t.height / 2 - e.height / 2;
    return e.top + window.scrollY - i
}
,
w1 = new WeakMap,
na = function(e, t, i, a, c) {
    if (e === "above") {
        let h = t.top + window.scrollY + o(this, w1) - i.height
          , f = 0;
        h < 0 && a ? c(v(this, P, y1).call(this, "below", !1)) : (this._position = "above",
        c({
            top: h,
            left: f
        }))
...
,
ra = function(e, t, i, a, c) {
    if (e === "below") {
        let h = t.bottom + window.scrollY + o(this, w1)
          , f = 0;
        h + i.height > window.innerHeight && a ? c(v(this, P, y1).call(this, "above", !1)) : (this._position = "below",
        c({
            top: h,
            left: f
        }))
...
,
aa = function(e, t, i, a, c) {
    if (e === "before") {
        let h = v(this, P, ln).call(this, t, i)
          , f = t.left - i.width - o(this, w1);
        f < 0 && a ? c(v(this, P, y1).call(this, "below", !1)) : (this._position = "before",
        c({
            top: h,
            left: f
        }))
...
,
sa = function(e, t, i, a, c) {
    if (e === "after") {
        let h = v(this, P, ln).call(this, t, i)
          , f = t.right + o(this, w1);
        f + i.width > window.innerWidth && a ? c(v(this, P, y1).call(this, "below", !1)) : (this._position = "after",
        c({
            top: h,
            left: f
        }))
...
y1 = function(e, t=!0) {
    return new Promise(i => {
        requestAnimationFrame( () => {
            let a = o(this, ze).getBoundingClientRect()
              , c = this.getBoundingClientRect();
            v(this, P, na).call(this, e, a, c, t, i),
            v(this, P, ra).call(this, e, a, c, t, i),
            v(this, P, aa).call(this, e, a, c, t, i),
            v(this, P, sa).call(this, e, a, c, t, i)
        }
        )
    }
    )
...
cn = function(e) {
    let t = this.getRootNode()
      , i = (t == null ? void 0 : t.querySelector) && t.querySelector(`#${e}`);
    return i || document.getElementById(e)
}
,
Ce.style = oa,
Ce.projectorMode = "replace",
Ce.POPOVER_SHOW_EVENT = "popover-show",
m([RenderOnSet], Ce.prototype, "_position", 2),
Ce = m([CustomElementConfig({
    tagName: "pggm-toggletip"
})], Ce);
var la = `ul[is=pggm-unordered-list],ul[is=pggm-unordered-list]>li{all:revert;padding:0 0 0 1em}ul[is=pggm-unordered-list],ul[is=pggm-unordered-list][marker=disc]{list-style:disc outside}ul[is=pggm-unordered-list][marker=circle]{list-style:circle outside}ul[is=pggm-unordered-list]>li::marker{color:var(--pggm-unordered-list-marker-border-color)}
`;
var At = class extends HTMLUListElement {
    connectedCallback() {
        return G(this, null, function*() {
            O(this.getRootNode(), la, At.TAG_NAME)
        })
    }
}
;
At.TAG_NAME = "pggm-unordered-list",
At = m([CustomElementConfig({
    tagName: At.TAG_NAME,
    options: {
        extends: "ul"
    }
})], At);
export {It as PGGMAccordion, ut as PGGMAnchorButton, mt as PGGMButton, S as PGGMCalendar, de as PGGMCheckbox, Re as PGGMCheckboxGroup, xe as PGGMDialog, he as PGGMErrorMessage, Rt as PGGMFieldset, Y as PGGMFileUpload, pe as PGGMHeading, ht as PGGMIcon, Kt as PGGMInlineContentBlock, Te as PGGMInput, wt as PGGMLabel, it as PGGMLink, Ne as PGGMNotification, oe as PGGMRadio, Ve as PGGMRadioGroup, kt as PGGMSelect, je as PGGMSwitch, Gd as PGGMTab, Ct as PGGMTextArea, Ce as PGGMToggletip, b1 as PGGMTooltip, At as PGGMUnorderedList};
