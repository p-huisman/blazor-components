...
public partial class PggmBankAccountInput : PggmEventComponentBase
{
    public override string TagName => "pggm-bank-account-input";

    private const string ValueProperty = "value";
    private string? _lastSyncedValue;

    /// <summary>
    /// The current bank account value as JSON string
    /// </summary>
    [Parameter] public string? Value { get; set; }

    /// <summary>
    /// Event callback for when the bank account value changes (two-way binding)
    /// </summary>
    [Parameter] public EventCallback<string?> ValueChanged { get; set; }

    /// <summary>
    /// The name attribute for the bank account input
    /// </summary>
    [Parameter] public string? Name { get; set; }

    /// <summary>
    /// The id attribute for the bank account input
    /// </summary>
    ...
    /// <summary>
    /// The country code for the bank account (e.g., "NL", "DE", "BE")
    /// </summary>
    ...
    /// </summary>
    [Parameter] public string LandenEndpoint { get; set; } = "https://staticweb-cdn-o.azureedge.net/design-system/api/financieel-landen.json";
    ...
    {
        await DesignSystemService.LoadScriptAsync("pggm-bank-account-input");
