...
var mr = `pggm-date-dropdown{display:none;visibility:hidden}pggm-date-dropdown[open]{display:block;left:0;left:var(--date-dropdown-left,0);position:absolute;top:0;top:var(--date-dropdown-top,0);visibility:visible;z-index:9999}pggm-calendar{background-color:var(--pggm-tooltip-background-color);border:0!important;border-radius:var(--pggm-tooltip-border-radius);-webkit-box-shadow:var(--pggm-tooltip-box-shadow);box-shadow:var(--pggm-tooltip-box-shadow);color:var(--pggm-tooltip-color)}
`;
